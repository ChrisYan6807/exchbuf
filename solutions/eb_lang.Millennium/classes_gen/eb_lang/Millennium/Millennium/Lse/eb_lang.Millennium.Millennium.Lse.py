...
class ExecutionReport(Packet):
    ...
    fields_desc = [
        ...
        String20("clientOrderId", ""),
        String12("orderId", ""),
        ByteEnumField("execType", ExecType.TRADE_CANCEL, ExecType),
        ...
        ByteEnumField("tradeLiquidityIndicator", LiquidityIndicator.AUCTION, LiquidityIndicator),
