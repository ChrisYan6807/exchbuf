...
ClearingTradePrice = float_decimal(8, 8, True, False, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
ClearingTradeQty = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
Delta = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
NettingCoefficient = float_decimal(8, 4, True, False, 0.0000, 1.0000, 0x8000000000000000)
...
QuoteRefPrice = float_decimal(8, 8, True, False, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
QuoteWeightingCoefficient = float_decimal(8, 4, True, False, 0.0000, 1.0000, 0x8000000000000000)
...
RiskLimitNetPositionQty = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
RiskLimitOpenQty = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
class RiskLimitPlatform(int, Enum):
    On_Book = 0
    Off_Book = 1

RiskLimitQty = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
StrikePrice = float_decimal(8, 8, True, False, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
TradeToQuoteRatio = float_decimal(8, 4, True, False, 0.0000, 100.0000, 0x8000000000000000)
...
TradeToRequestRatio = float_decimal(8, 4, True, False, 0.0000, 100.0000, 0x8000000000000000)
...
UnderlyingDeltaPercentage = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
UnderlyingEffectiveDeltaPercentage = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
UnderlyingIssuer = fixed_length_string(30, b'\0')
UnderlyingMaturityDate = integer_type(LEIntField, 0, 99991231, 0xFFFFFFFF)
UnderlyingPriceStipValue = float_decimal(8, 8, True, False, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
UnderlyingPx = float_decimal(8, 8, True, False, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
UnderlyingQty = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
Vega = float_decimal(8, 4, True, False, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
class QuoteEntryAckGrpComp(Packet):
    ...
    fields_desc = [
        ...
        LEIntEnumField("quoteEntryRejectReason", QuoteEntryRejectReason.BU_Suspend_ARP_Level_3_Soft_Breach, QuoteEntryRejectReason),
...
class DeleteAllOrderBroadcast(Packet):
    ...
    fields_desc = [
        ...
        ByteEnumField("partyIDEnteringFirm", PartyIDEnteringFirm.MarketSupervision, PartyIDEnteringFirm),
        ByteEnumField("massActionReason", MassActionReason.Member_disable, MassActionReason),
