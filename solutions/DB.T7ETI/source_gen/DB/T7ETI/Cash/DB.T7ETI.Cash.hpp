...
using AccruedInteresAmt = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using AutoExecLimitPrice = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using CouponRate = BigEndian<int64_t, -922337203685.4775807, 922337203685.4775807, 0x8000000000000000, 7>;
...
using DisplayHighQty = BigEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
using DisplayLowQty = BigEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
using DisplayQty = BigEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
...
using EventPx = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using ImbalanceQty = BigEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
...
using PegOffsetValueAbs = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
using PegOffsetValuePct = BigEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
using PotentialExecVolume = BigEndian<int64_t, -214748.3647, 214748.3647, 0x8000000000000000, 4>;
...
using RiskLimitAmount = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
using RiskLimitGroup = FixedLengthString<3, 0>;
using RiskLimitNetPositionAmount = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
using RiskLimitOpenAmount = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using SettlCurrAmt = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
using SettlCurrFxRate = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using SideGrossTradeAmt = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
...
using VolumeDiscoveryPrice = BigEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
#pragma pack(1)
...
inline std::ostream& operator<<(std::ostream& os, const ExtendedDeletionReport& msg) {
    os << "messageHeaderOut=" << msg.messageHeaderOut << ";"
       ...
       << "stopPx=" << msg.stopPx << ";"
       << "volumeDiscoveryPrice=" << msg.volumeDiscoveryPrice << ";"
