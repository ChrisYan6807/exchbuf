from .common import *
# EuroNext -- OEG Binary version: 335
...
class Ack(Packet):
    ...
    fields_desc = [
        ...
        ByteEnumField("eMM", EMM_enum.Not_Applicable, EMM_enum),
        ByteEnumField("orderSide", OrderSide_enum.Cross, OrderSide_enum),
        ByteEnumField("ackType", AckType_enum.Move_Dark_to_COB_as_Market, AckType_enum),
        ...
        int64_t("orderTolerablePrice", -9223372036854775808),
...
class Fill(Packet):
    ...
    fields_desc = [
        ...
        ByteEnumField("tradeType", TradeType_enum.RFQ_Trade, TradeType_enum),
...
class Kill(Packet):
    ...
    fields_desc = [
        ...
        uint32_t("symbolIndex", 4294967295),
        ByteEnumField("eMM", EMM_enum.Not_Applicable, EMM_enum),
        LEShortEnumField("killReason", KillReason_enum.Cancelled_due_to_Breach_of_MEP_set_by_a_member_risk_manager, KillReason_enum),
        PacketField("ackQualifiers", 0, AckQualifiers_set),
...
class UserNotification(Packet):
    ...
    fields_desc = [
        ...
        char8("familyID", ""),
        uint32_t("symbolIndex", 4294967295),
        ByteEnumField("userStatus", UserStatus_enum.No_Action_in_place, UserStatus_enum),
        uint32_t("logicalAccessID", 4294967295),
