...
struct TestRequest : MsgHeader {
    ...
    UInt32 chksum;
    TestRequest():MsgHeader(MsgType::TestRequest, 0b1 << 63) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct ResendRequest : MsgHeader {
    ...
    UInt32 endSeq;
    UInt32 chksum;
    ResendRequest():MsgHeader(MsgType::ResendRequest, 0b11 << 62) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct Reject : MsgHeader {
    ...
    FloatingRef<UInt32> chksum() {return FloatingRef<UInt32>(text().end());}
    Reject():MsgHeader(MsgType::Reject, 0b1 << 63) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct BusinessReject : MsgHeader {
    ...
    BusinessReject():MsgHeader(MsgType::BusinessReject, 0b1 << 63) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct News : MsgHeader {
    ...
    String251 newsText;
    UInt32 chksum;
    News():MsgHeader(MsgType::News, b1111 << 60) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct SecurityDefinitionRequest : MsgHeader {
    ...
    SecurityDefinitionRequest():MsgHeader(MsgType::SecurityDefinitionRequest, 0b111111 << 58) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct SecurityDefinition : MsgHeader {
    ...
    FloatingRef<UInt32> chksum() {return FloatingRef<UInt32>(text().end());}
    SecurityDefinition():MsgHeader(MsgType::SecurityDefinition, 0b111 << 61) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct CancelOrder : MsgHeader {
    ...
    UInt64 transactTime;
    Side side;
    CancelOrder():MsgHeader(MsgType::CancelOrder, 0b1001111 << 57) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
...
struct MassCancelRequest : MsgHeader {
    ...
    FloatingRef<UInt32> chksum() {return FloatingRef<UInt32>(side().end());}
    MassCancelRequest():MsgHeader(MsgType::MassCancelRequest, 0b1111 << 60) {};
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
