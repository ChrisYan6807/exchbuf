...
inline std::string eti_CashAppVersionID = "14.0";
namespace DBETI_140_Cash {
...
struct ClearingInstruction {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(13), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(13), });
...
struct MatchType {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(7), static_cast<uint8_t>(11), static_cast<uint8_t>(12), static_cast<uint8_t>(14), static_cast<uint8_t>(15), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(7), static_cast<uint8_t>(11), static_cast<uint8_t>(12), static_cast<uint8_t>(14), static_cast<uint8_t>(15), });
...
struct TradingSessionSubID {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(4), static_cast<uint8_t>(6), static_cast<uint8_t>(8), static_cast<uint8_t>(105), static_cast<uint8_t>(106), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(4), static_cast<uint8_t>(6), static_cast<uint8_t>(8), static_cast<uint8_t>(105), static_cast<uint8_t>(106), });
...
struct TemplateID {
    ...
    enum Enum : value_type {
        ...
        SpecialistRFQRejectRequest = 10421,
        SpecialistRFQReplyNotification = 10424,
        SpecialistRFQReplyRequest = 10422,
        SpecialistRFQReplyResponse = 10423,
    ...
    constexpr const std::string_view view() const {
        switch(value_) {
            ...
            case Enum::RFQSpecialistBroadcast: return "RFQSpecialistBroadcast";
            case Enum::Reject: return "Reject";
            ...
            case Enum::SpecialistRFQRejectRequest: return "SpecialistRFQRejectRequest";
            case Enum::SpecialistRFQReplyNotification: return "SpecialistRFQReplyNotification";
            case Enum::SpecialistRFQReplyRequest: return "SpecialistRFQReplyRequest";
            case Enum::SpecialistRFQReplyResponse: return "SpecialistRFQReplyResponse";
...
struct RFQSpecialistBroadcast {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(RFQSpecialistBroadcast);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct SpecialistRFQRejectRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(SpecialistRFQRejectRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct SpecialistRFQReplyNotification {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(SpecialistRFQReplyNotification);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct SpecialistRFQReplyRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(SpecialistRFQReplyRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct SpecialistRFQReplyResponse {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(SpecialistRFQReplyResponse);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
} // end of namespace DBETI_140_Cash
