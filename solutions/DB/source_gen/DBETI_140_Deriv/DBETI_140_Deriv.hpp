...
//Deutsche Börse -- market: eti_Derivatives, version: 14.0, subVersion: D0002, buildNumber: 140.610.3.ga-140006010-6

inline std::string eti_DerivativesAppVersionID = "14.0";
namespace DBETI_140_Deriv {
...
using NotAffectedSecurityID = LittleEndian<uint64_t, 0UL, 18446744073709551614UL, 0xFFFFFFFFFFFFFFFFUL>;
...
using Pad5_1 = FixedLengthString<5, '\0', false>;
using Pad6 = FixedLengthString<6, '\0', false>;
using Pad6_1 = FixedLengthString<6, '\0', false>;
...
struct QuoteEventType {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(6), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(6), });
...
struct TrdType {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint16_t>(1), static_cast<uint16_t>(12), static_cast<uint16_t>(1000), static_cast<uint16_t>(1001), static_cast<uint16_t>(1002), static_cast<uint16_t>(1004), static_cast<uint16_t>(1006), static_cast<uint16_t>(1007), static_cast<uint16_t>(1010), static_cast<uint16_t>(1011), static_cast<uint16_t>(1017), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint16_t>(1), static_cast<uint16_t>(12), static_cast<uint16_t>(1000), static_cast<uint16_t>(1001), static_cast<uint16_t>(1002), static_cast<uint16_t>(1004), static_cast<uint16_t>(1006), static_cast<uint16_t>(1007), static_cast<uint16_t>(1010), static_cast<uint16_t>(1011), static_cast<uint16_t>(1017), });
...
struct TemplateID {
    ...
    constexpr const std::string_view view() const {
        switch(value_) {
            ...
            case Enum::DeleteOrderComplexRequest: return "DeleteOrderComplexRequest";
            ...
            case Enum::ModifyOrderComplexRequest: return "ModifyOrderComplexRequest";
            case Enum::ModifyOrderComplexShortRequest: return "ModifyOrderComplexShortRequest";
            ...
            case Enum::ModifyOrderSingleRequest: return "ModifyOrderSingleRequest";
            case Enum::ModifyOrderSingleShortRequest: return "ModifyOrderSingleShortRequest";
            case Enum::ModifyTESTradeRequest: return "ModifyTESTradeRequest";
            case Enum::NewOrderComplexRequest: return "NewOrderComplexRequest";
            case Enum::NewOrderComplexShortRequest: return "NewOrderComplexShortRequest";
            ...
            case Enum::NewOrderSingleRequest: return "NewOrderSingleRequest";
            case Enum::NewOrderSingleShortRequest: return "NewOrderSingleShortRequest";
...
struct DeleteOrderComplexRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(DeleteOrderComplexRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct DeleteOrderSingleRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(DeleteOrderSingleRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct ModifyOrderComplexRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(ModifyOrderComplexRequest);}
...
struct ModifyOrderComplexShortRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(ModifyOrderComplexShortRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct ModifyOrderSingleRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(ModifyOrderSingleRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct ModifyOrderSingleShortRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(ModifyOrderSingleShortRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct NewOrderComplexRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(NewOrderComplexRequest);}
    size_t var_size() const {return legOrdGrp().end()-begin();}
};
#pragma pack()
...
struct NewOrderComplexShortRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(NewOrderComplexShortRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct NewOrderSingleRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(NewOrderSingleRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
struct NewOrderSingleShortRequest {
    ...
    char* end() {return begin()+length();}
    const char* cend() const {return begin()+length();}
    size_t size() const {return sizeof(NewOrderSingleShortRequest);}
    size_t var_size() const {return size();}
};
#pragma pack()
...
} // end of namespace DBETI_140_Deriv
