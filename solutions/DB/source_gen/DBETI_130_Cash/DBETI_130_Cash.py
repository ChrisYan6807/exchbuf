...
AccruedInteresAmt = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
AutoExecLimitPrice = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
CouponRate = float_decimal(8, 7, True, True, -922337203685.4775807, 922337203685.4775807, 0x8000000000000000)
...
class DeliveryType(int, Enum):
    ...
    WPR = 4
    AKT = 5
DisplayHighQty = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
DisplayLowQty = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
DisplayQty = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
EventPx = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
ImbalanceQty = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
class MidPointType(int, Enum):
    MidPoint = 1
    MidPointSweep = 2
MinQty = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
...
NoSideOTCAllocs = integer_type(ByteField, 1, 2, 0xFF)
...
OTCExecID = integer_type(LEIntField, 0, 4294967294, 0xFFFFFFFF)
...
PegOffsetValueAbs = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
PegOffsetValuePct = float_decimal(8, 4, True, True, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000)
PotentialExecVolume = float_decimal(8, 4, True, True, -214748.3647, 214748.3647, 0x8000000000000000)
...
class RiskLimitAction(int, Enum):
    ...
    Reject = 2
    Warning = 4
RiskLimitAmount = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
RiskLimitGroup = fixed_length_string(3, b'\0')
RiskLimitNetPositionAmount = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
RiskLimitOpenAmount = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
SettlCurrAmt = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
SettlCurrFxRate = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
class SideDisclosureInstruction(int, Enum):
    No = 0
    Yes = 1
SideGrossTradeAmt = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
...
TransactionCostAmt = float_decimal(8, 8, True, True, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000)
class TransactionCostCode(int, Enum):
...
class QuoteEventGrpComp(Packet):
    ...
    fields_desc = [
        ...
        ByteEnumField("bBOSetting", BBOSetting.Yes, BBOSetting)
...
class SideAllocOTCGrpComp(Packet):
    name = 'SideAllocOTCGrpComp'
    fields_desc = [
        ByteEnumField("side", Side.Sell, Side)
...
class DeleteOrderBroadcast(Packet):
    ...
    fields_desc = [
        ...
        PartyIDEnteringTrader("partyIDEnteringTrader", 0xFFFFFFFF)
        PartyIDSessionID("partyIDSessionID", 0xFFFFFFFF)
        LEShortEnumField("execRestatementReason", ExecRestatementReason.RLP_Order_Quote_Cleanup, ExecRestatementReason)
        ByteEnumField("partyIDEnteringFirm", PartyIDEnteringFirm.MarketSupervision, PartyIDEnteringFirm)
...
class OTCResponse(Packet):
    name = 'OTCResponse'
    fields_desc = [
        PacketField("messageHeaderOut", "", MessageHeaderOutComp)
        PacketField("responseHeader", "", ResponseHeaderComp)
        OTCExecID("oTCExecID", 0xFFFFFFFF)
        TradeReportID("tradeReportID", "")
    ]
class OTCUploadBroadcast(Packet):
    name = 'OTCUploadBroadcast'
    fields_desc = [
        PacketField("messageHeaderOut", "", MessageHeaderOutComp)
        PacketField("rBCHeader", "", RBCHeaderComp)
        OTCExecID("oTCExecID", 0xFFFFFFFF)
        ...
        LastQty("lastQty", 0x8000000000000000)
        SettlCurrFxRate("settlCurrFxRate", 0x8000000000000000)
        TransactionCostAmt("transactionCostAmt", 0x8000000000000000)
        TransBkdTime("transBkdTime", 0xFFFFFFFFFFFFFFFF)
        TransactTime("transactTime", 0xFFFFFFFFFFFFFFFF)
        MarketSegmentID("marketSegmentID", 0x80000000)
        PackageID("packageID", 0xFFFFFFFF)
        ...
        ByteEnumField("tradePublishIndicator", TradePublishIndicator.Published, TradePublishIndicator)
        FieldLenField("noSideOTCAllocs", 0, fmt="<B", count_of="sideAllocOTCGrp")
        ByteEnumField("transactionCostCode", TransactionCostCode.Provision, TransactionCostCode)
        ByteEnumField("tradePlatform", TradePlatform.On_Book, TradePlatform)
        SettlCurrency("settlCurrency", "")
        TradeReportID("tradeReportID", "")
        RegulatoryTradeID("regulatoryTradeID", "")
        Pad1("pad1", "")
        PacketListField("sideAllocOTCGrp", None, SideAllocOTCGrpComp, count_from=lambda pkt:pkt.noSideOTCAllocs
    ]
class OTCUploadRequest(Packet):
    name = 'OTCUploadRequest'
    fields_desc = [
        PacketField("messageHeaderIn", "", MessageHeaderInComp)
        PacketField("requestHeader", "", RequestHeaderComp)
        SecurityID("securityID", 0x8000000000000000)
...
class Reject(Packet):
    ...
    fields_desc = [
        PacketField("messageHeaderOut", "", MessageHeaderOutComp)
        PacketField("nRResponseHeaderME", "", NRResponseHeaderMEComp)
        LEIntEnumField("sessionRejectReason", SessionRejectReason.Price_Not_Reasonable_Extended, SessionRejectReason)
        FieldLenField("varTextLen", 0, fmt="<H", count_of="varText")
        ByteEnumField("sessionStatus", SessionStatus.Logout, SessionStatus)
        PacketListField("varText", None, VarText, count_from=lambda pkt:pkt.varTextLen
    ]
