...
//Deutsche Börse -- market: eti_Cash, version: 13.0, subVersion: C0002, buildNumber: 130.542.0.ga-130005042-4

namespace DBETI_130_Cash {
...
struct ExecRestatementReason {
    ...
    static constexpr const value_type min_value = std::min<value_type>({static_cast<uint16_t>(0), static_cast<uint16_t>(1), static_cast<uint16_t>(8), static_cast<uint16_t>(101), static_cast<uint16_t>(102), static_cast<uint16_t>(103), static_cast<uint16_t>(105), static_cast<uint16_t>(107), static_cast<uint16_t>(108), static_cast<uint16_t>(114), static_cast<uint16_t>(119), static_cast<uint16_t>(122), static_cast<uint16_t>(138), static_cast<uint16_t>(141), static_cast<uint16_t>(139), static_cast<uint16_t>(142), static_cast<uint16_t>(146), static_cast<uint16_t>(148), static_cast<uint16_t>(149), static_cast<uint16_t>(150), static_cast<uint16_t>(151), static_cast<uint16_t>(152), static_cast<uint16_t>(153), static_cast<uint16_t>(154), static_cast<uint16_t>(159), static_cast<uint16_t>(160), static_cast<uint16_t>(155), static_cast<uint16_t>(164), static_cast<uint16_t>(172), static_cast<uint16_t>(181), static_cast<uint16_t>(197), static_cast<uint16_t>(199), static_cast<uint16_t>(205), static_cast<uint16_t>(212), static_cast<uint16_t>(213), static_cast<uint16_t>(237), static_cast<uint16_t>(238), static_cast<uint16_t>(241), static_cast<uint16_t>(242), static_cast<uint16_t>(243), static_cast<uint16_t>(245), static_cast<uint16_t>(246), static_cast<uint16_t>(261), static_cast<uint16_t>(292), static_cast<uint16_t>(294), static_cast<uint16_t>(295), static_cast<uint16_t>(296), static_cast<uint16_t>(297), static_cast<uint16_t>(298), static_cast<uint16_t>(300), static_cast<uint16_t>(316), static_cast<uint16_t>(320), });
...
struct FillLiquidityInd {
    ...
    static constexpr const value_type min_value = std::min<value_type>({static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(6), static_cast<uint8_t>(7), static_cast<uint8_t>(100), static_cast<uint8_t>(101), });
    static constexpr const value_type max_value = std::max<value_type>({static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(6), static_cast<uint8_t>(7), static_cast<uint8_t>(100), static_cast<uint8_t>(101), });
...
struct MatchType {
    ...
    static constexpr const value_type min_value = std::min<value_type>({static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(7), static_cast<uint8_t>(11), static_cast<uint8_t>(12), static_cast<uint8_t>(14), static_cast<uint8_t>(15), });
    static constexpr const value_type max_value = std::max<value_type>({static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), static_cast<uint8_t>(7), static_cast<uint8_t>(11), static_cast<uint8_t>(12), static_cast<uint8_t>(14), static_cast<uint8_t>(15), });
...
struct MidPointType {
    ...
    constexpr const bool operator==(const MidPointType& rhs) const {return value_ == rhs.value_;}
    constexpr const bool operator!=(const MidPointType& rhs) const {return value_ != rhs.value_;}
    constexpr const Enum value() const {return value_;}
    constexpr const uint8_t raw_value() const {return static_cast<uint8_t>(value_);}
    constexpr const void raw_value(uint8_t v) {value_ = Enum(v);}
...
using MinQty = LittleEndian<int64_t, -922337203685477.5807, 922337203685477.5807, 0x8000000000000000, 4>;
...
using NoSideOTCAllocs = LittleEndian<uint8_t, 1_u8, 2_u8, 0x_u8FF>;
...
using OTCExecID = LittleEndian<uint32_t, 0, 4294967294, 0xFFFFFFFF>;
...
using TransactionCostAmt = LittleEndian<int64_t, -92233720368.54775807, 92233720368.54775807, 0x8000000000000000, 8>;
struct TransactionCostCode {
    ...
    static constexpr const value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), });
    static constexpr const value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), static_cast<uint8_t>(5), });
    ...
    constexpr const bool operator==(const TransactionCostCode& rhs) const {return value_ == rhs.value_;}
    constexpr const bool operator!=(const TransactionCostCode& rhs) const {return value_ != rhs.value_;}
    constexpr const Enum value() const {return value_;}
    constexpr const uint8_t raw_value() const {return static_cast<uint8_t>(value_);}
    constexpr const void raw_value(uint8_t v) {value_ = Enum(v);}
...
struct SideAllocOTCGrpComp {
    ...
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
    size_t size() {return sizeof(SideAllocOTCGrpComp);}
    size_t length() {return size();}
};
#pragma pack()
...
struct OTCResponse {
    ...
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
    size_t size() {return sizeof(OTCResponse);}
    size_t length() {return size();}
};
#pragma pack()
...
struct OTCUploadBroadcast {
    ...
    TransactionCostCode transactionCostCode;
    TradePlatform tradePlatform;
    SettlCurrency settlCurrency;
    TradeReportID tradeReportID;
    RegulatoryTradeID regulatoryTradeID;
    Pad1 pad1;
    BlockRef<SideAllocOTCGrpComp> sideAllocOTCGrp() {return BlockRef<SideAllocOTCGrpComp>(begin()+size(), noSideOTCAllocs);}
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
    size_t size() {return sizeof(OTCUploadBroadcast);}
    size_t length() {return sideAllocOTCGrp().end()-begin();}
};
#pragma pack()
...
struct OTCUploadRequest {
    ...
    char* begin() {return reinterpret_cast<char*>(this);}
    char* end() {return begin()+length();}
    size_t size() {return sizeof(OTCUploadRequest);}
    size_t length() {return sideAllocOTCGrp().end()-begin();}
};
#pragma pack()
...
} // end of namespace DBETI_130_Cash
