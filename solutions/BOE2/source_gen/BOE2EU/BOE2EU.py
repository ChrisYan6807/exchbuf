...
class Header(Packet):
    ...
    u16("messageLength", 0),
    ByteEnumField("msgType", MsgType.LoginRequestV2, MsgType),
    u8("matchingUnit", 0),
    u32("seqNum", 0),
    ]
...
class ParaGrp(Packet):
    ...
    fields_desc = [
    u16("length", 0),
    ByteEnumField("paraGrpType", ParaGrpType.UnitSeq, ParaGrpType),
...
class LoginResponseV2(Packet):
    ...
    fields_desc = [
    CharEnumField("status", LoginResponseStatus.LoginAccepted, LoginResponseStatus),
    str60("text", ""),
    u8("noUnspecifiedUnitReplay", 0),
    u32("lastRcvSeqNum", 0),
...
class Logout(Packet):
    name = 'Logout'
    fields_desc = [
    CharEnumField("reason", LogoutReason.UserRequested, LogoutReason),
    str60("text", ""),
    u32("lastRcvSeqNum", 0),
...
class OrderRejectedV2(Packet):
    ...
    u64("transTime", 0),
    str20("clOrdID", ""),
    CharEnumField("code", ReasonCode.Admin, ReasonCode),
    str60("text", ""),
    u8("reserved", 0),
    PacketField("optGrp", "", OrderRespOptGrp),
    ]
...
class OrderExecutionV2(Packet):
    ...
    Price4("lastPx", 0),
    u32("leavesQty", 0),
    CharEnumField("liqInd", LiqIndicator.Added, LiqIndicator),
    CharEnumField("subLiqInd", SubLiquidityIndicator.NO, SubLiquidityIndicator),
    str4("contraBroker", ""),
    u8("reserved", 0),
    PacketField("optGrp", "", OrderRespOptGrp),
    ]
