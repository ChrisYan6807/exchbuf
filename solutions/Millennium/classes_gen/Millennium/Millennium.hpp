...
struct MissedMsgRespType {
    ...
    static constexpr size_t size = 1;
    static constexpr char* name() {return "MissedMsgRespType";}
...
struct MissedMsgRptType {
    ...
    static constexpr size_t size = 1;
    static constexpr char* name() {return "MissedMsgRptType";}
...
struct AppID {
    ...
    static constexpr size_t size = 1;
    static constexpr char* name() {return "AppID";}
...
struct AppStatus {
    ...
    static constexpr size_t size = 1;
    static constexpr char* name() {return "AppStatus";}
...
inline std::ostream& operator<<(std::ostream& os, const Heartbeat& msg) {
    os << static_cast<const MsgHeader&>(msg);os << "}";
    return os;
}
