...
class NewOrder(Packet):
    ...
    ByteEnumField("ownerType", OwnerType.RetailLP, OwnerType),
    ...
    Int8("reserved3", 0),
    Int8("reserved4", 0),
    ByteEnumField("pegPriceType", PegPriceType.BestOffer, PegPriceType),
...
class ExecutionReport(Packet):
    ...
    ByteEnumField("lastMkt", LastMkt.TQEM, LastMkt),
    ByteEnumField("pegPriceType", PegPriceType.BestOffer, PegPriceType),
    ByteEnumField("ownerType", OwnerType.RetailLP, OwnerType),
