...
using byte = LittleEndian<char, std::numeric_limits<int8_t>::min(), std::numeric_limits<int8_t>::max(), 0>;
...
struct CLSE {
    ...
    static constexpr size_t size = 1;
    static constexpr char* name() {return "CLSE";}
...
struct NewOrder : MsgHeader {
    ...
    Anonymity anonymity{Anonymity::null};
...
struct ExecutionReport : MsgHeader {
    ...
    Int32 displayQty;
    Int32 instrumentId;
    RestatementReason restatementReason{RestatementReason::null};
    Int8 reserved1;
    Side side{Side::null};
    Uint64 reserved2;
