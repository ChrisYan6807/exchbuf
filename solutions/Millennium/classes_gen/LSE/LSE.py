...
class NewOrder(Packet):
    ...
    ByteEnumField("anonymity", Anonymity.ANONYMOUS, Anonymity),
...
class ExecutionReport(Packet):
    ...
    Int32("displayQty", 0),
    Int32("instrumentId", 0),
    ByteEnumField("restatementReason", RestatementReason.REPRICED, RestatementReason),
    Int8("reserved1", 0),
    ByteEnumField("side", Side.BUY, Side),
    Uint64("reserved2", 0),
    ...
    ByteEnumField("lastMakt", LastMkt.XLON, LastMkt),
