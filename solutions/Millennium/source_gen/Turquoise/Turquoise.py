...
class WaiverFlags(Packet):
    fields_desc = [
        BitEnumField('Dummy', Dummy.NA, 5, Dummy),
...
class WaiverFlags2(Packet):
    fields_desc = [
        BitEnumField('Dummy', Dummy.NA, 1, Dummy),
        BitEnumField('NETW', NETW.No, 1, NETW),
...
class NewOrder(Packet):
    ...
    String11("traderId", ""),
    String10("account", ""),
    ByteEnumField("clearingAccount", ClearingAccount.CLIENT, ClearingAccount),
    String8("commonSymbol", ""),
    ByteEnumField("orderType", OrderType.MAKKET, OrderType),
    ByteEnumField("tif", TimeInForce.DAY, TimeInForce),
    ...
    ByteEnumField("autoCancel", AutoCancel.DO_NOT_CANCEL, AutoCancel),
    ByteEnumField("orderSubType", OrderSubType.ORDER, OrderSubType),
    ByteEnumField("ownerType", OwnerType.NonRetail, OwnerType),
    MillenniumPrice("reserved2", 0),
    ByteEnumField("targetBook", TargetBook.TRQM, TargetBook),
    ByteEnumField("execInstruction", ExecInstruction.USER_LEVEL_DEFAULT, ExecInstruction),
    Int32("minimumQuantity", 0),
    Int8("reserved3", 0),
    Int8("reserved4", 0),
    ByteEnumField("pegPriceType", PegPriceType.Default, PegPriceType),
...
class ExecutionReport(Packet):
    ...
    ByteEnumField("ordStatus", OrdStatus.NEW, OrdStatus),
    ...
    CharEnumField("tradeLiquidityIndicator", LiquidityIndicator.ADDED, LiquidityIndicator),
    Uint64("tradeMatchId", 0),
    Uint64("transactTime", 0),
    ByteEnumField("targetBook", TargetBook.TRQM, TargetBook),
    ByteEnumField("typeOfTrade", TypeOfTrade.VISIBLE, TypeOfTrade),
    ByteEnumField("capacity", OrderCapacity.MTCH, OrderCapacity),
    Alpha("reserved2", 0),
    String12("publicOrderId", ""),
    Int32("minimumQty", 0),
    Int8("reputationalScore", 0),
    ByteEnumField("lastMkt", LastMkt.TRQX, LastMkt),
    ByteEnumField("pegPriceType", PegPriceType.Default, PegPriceType),
    ByteEnumField("ownerType", OwnerType.NonRetail, OwnerType),
    PacketField("waiverFlags2", 0, WaiverFlags2),
    String21("reserved3", ""),
    ]
