...
struct OwnerType {
    ...
    static constexpr const char* name() {return "OwnerType";}
...
struct PegPriceType {
    ...
    static constexpr const char* name() {return "PegPriceType";}
...
struct NETW {
    ...
    static constexpr const char* name() {return "NETW";}
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
...
struct NewOrder : MsgHeader {
    ...
    OwnerType ownerType{OwnerType::NonRetail};
    MillenniumPrice reserved2;
    TargetBook targetBook{TargetBook::TRQM};
    ExecInstruction execInstruction{ExecInstruction::USER_LEVEL_DEFAULT};
    Int32 minimumQuantity;
    Int8 reserved3;
    Int8 reserved4;
    PegPriceType pegPriceType{PegPriceType::Default};
