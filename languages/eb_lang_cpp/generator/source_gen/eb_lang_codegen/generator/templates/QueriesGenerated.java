...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_0_18(final PropertyMacroContext _context) {
    ...
    out_str += String.format("%sreturn os;\n}", indent);
  ...
  public static Object propertyMacro_GetValue_0_24(final PropertyMacroContext _context) {
    ...
    if (fixed_len) {
      if ((boolean) EBMessageMember__BehaviorDescriptor.isNotFixedLength_id2D23R1vLKti.invoke(_context.getNode())) {
        return String.format("    FloatingRef<%1$s> %2$s() {return FloatingRef<%1$s>(begin() + fixed_size());}\n", SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), CONCEPTS.EBMessageEntryMember$fS), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL)) + String.format("    FloatingRef<%1$s> %2$s() const {return FloatingRef<%1$s>(cbegin() + fixed_size());}", SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), CONCEPTS.EBMessageEntryMember$fS), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL));
      ...
      return String.format("    FloatingRef<%1$s> %2$s() {return FloatingRef<%1$s>(%3$s().end());}\n", SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), CONCEPTS.EBMessageEntryMember$fS), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL)) + String.format("    FloatingRef<%1$s> %2$s() const {return FloatingRef<%1$s>(%3$s().cend());}", SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(_context.getNode(), CONCEPTS.EBMessageEntryMember$fS), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL));
    }
  ...
  public static Object propertyMacro_GetValue_0_25(final PropertyMacroContext _context) {
    ...
    if (SNodeOperations.isInstanceOf(typeNode, CONCEPTS.EBEnum$37)) {
      ...
      String defaultValue = EBMessageEntryMember__BehaviorDescriptor.fmtPyDefault_id7hSmxNQ3d9n.invoke(_context.getNode());
      if ((defaultValue == null || defaultValue.length() == 0)) {
  ...
  public static Object propertyMacro_GetValue_0_26(final PropertyMacroContext _context) {
    ...
    String defaultValue = "";
    if (isNotEmptyString(SPropertyOperations.getString(_context.getNode(), PROPS.default$w7ZO))) {
      defaultValue = String.format(" [ default=%s] ", SPropertyOperations.getString(_context.getNode(), PROPS.default$w7ZO));
    }
    return String.format("  %s %s", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), defaultValue);
  }
  public static Object propertyMacro_GetValue_0_27(final PropertyMacroContext _context) {
    ...
    if (!((boolean) EBMessageMember__BehaviorDescriptor.isNotFixedLenMember_id_KNfA4Q0le.invoke(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R)))) {
      return String.format("    BlockRef<%s> %s() {return BlockRef<%s>(begin()+fixed_size(), %s);}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL)) + "\n" + String.format("    BlockRef<%s> %s() const {return BlockRef<%s>(cbegin()+fixed_size(), %s);}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL));

    } else {
      if ((boolean) EBMessageMember__BehaviorDescriptor.isNotFixedLenMember_id_KNfA4Q0le.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe))) {
        return String.format("    BlockRef<%s> %s() {return BlockRef<%s>(%s().end(), %s());}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL)) + "\n" + String.format("    BlockRef<%s> %s() const {return BlockRef<%s>(%s().cend(), %s());}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL));
      } else {
        return String.format("    BlockRef<%s> %s() {return BlockRef<%s>(%s().end(), %s);}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL)) + "\n" + String.format("    BlockRef<%s> %s() const {return BlockRef<%s>(%s().cend(), %s);}", SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.counter$kzoe), PROPS.name$MnvL));
      }
    }
  ...
  public static Object propertyMacro_GetValue_0_33(final PropertyMacroContext _context) {
    ...
    return comment + String.format("    auto %1$s() {return OptionalByLengthRef<%2$s, %3$s, decltype(%4$s)&>(begin()+fixed_size(), %4$s);\n", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), enumType, SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n)) + String.format("    auto %1$s() const {return OptionalByLengthRef<%2$s, %3$s, const decltype(%4$s)&>(begin()+fixed_size(), %4$s);", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), enumType, SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n));
  ...
  public static Object propertyMacro_GetValue_0_34(final PropertyMacroContext _context) {
    ...
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), CONCEPTS.EBEnum$37)) {
      ...
      return String.format("        ConditionalField(PacketListField(\"%s\", [], %s, length_from=lambda pkt:pkt.%s), lambda pkt:pkt.%s > 0),", pyTypeName, SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n), PROPS.name$MnvL));
      ...
      return String.format("        ConditionalField(PacketListField(\"%s\", [], %s, length_from=lambda pkt:pkt.%s), lambda pkt:pkt.%s > 0),", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.presence_len$vS6n), PROPS.name$MnvL));
  ...
  public static Object propertyMacro_GetValue_0_36(final PropertyMacroContext _context) {
    ...
    for (SNode n : SLinkOperations.getChildren(_context.getNode(), LINKS.values$fyud)) {
      String s = String.format("TypeByEnum<%s, %s, %s::%s>", SPropertyOperations.getString(SLinkOperations.getTarget(n, LINKS.type$_vIh), PROPS.name$MnvL), enumType, enumType, SLinkOperations.getTarget(n, LINKS.enum_value$_vXi));
      --sz;
      Args += s + ((sz == 0 ? "\n                          " : ",\n                                   "));
    }
  ...
  public static Object propertyMacro_GetValue_0_42(final PropertyMacroContext _context) {
    ...
    if (fixed_len) {
      return String.format("    auto %1$s() {\n        auto pred = [this](){return %3$s&%4$s::%5$s != 0;};\n        return OptionalByUnaryPredRef<%2$s, decltype(pred)>(begin()+fixed_size(), pred);\n    }\n", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SLinkOperations.getTarget(_context.getNode(), LINKS.presence_val$MrAR), SLinkOperations.getTarget(_context.getNode(), LINKS.target_enum$Mx0e), SLinkOperations.getTarget(_context.getNode(), LINKS.mask$Mxff)) + String.format("    auto %1$s() const {\n        auto pred = [this](){return %3$s&%4$s::%5$s != 0;};\n        return OptionalByUnaryPredRef<%2$s, decltype(pred)>(cbegin()+fixed_size(), pred);\n    }", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SLinkOperations.getTarget(_context.getNode(), LINKS.presence_val$MrAR), SLinkOperations.getTarget(_context.getNode(), LINKS.target_enum$Mx0e), SLinkOperations.getTarget(_context.getNode(), LINKS.mask$Mxff));

    } else {
      return String.format("    auto %1$s() {\n        auto pred = [this](){auto p=%3$s(); return p && p.value() & %4$s::%5$s != 0;};\n        return OptionalByUnaryPredRef<%2$s, decltype(pred)>(%6$s().end(), pred);\n    }\n", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SLinkOperations.getTarget(_context.getNode(), LINKS.presence_val$MrAR), SLinkOperations.getTarget(_context.getNode(), LINKS.target_enum$Mx0e), SLinkOperations.getTarget(_context.getNode(), LINKS.mask$Mxff), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL)) + String.format("    auto %1$s() const {\n        auto pred = [this](){auto p=%3$s(); return p && p.value() & %4$s::%5$s != 0;};\n        return OptionalByUnaryPredRef<%2$s, decltype(pred)>(%6$s().cend(), pred);\n    }", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.type$zO4N), PROPS.name$MnvL), SLinkOperations.getTarget(_context.getNode(), LINKS.presence_val$MrAR), SLinkOperations.getTarget(_context.getNode(), LINKS.target_enum$Mx0e), SLinkOperations.getTarget(_context.getNode(), LINKS.mask$Mxff), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL));
    }
  ...
  public static Object propertyMacro_GetValue_0_48(final PropertyMacroContext _context) {
    ...
    if (fixed_len) {
      return String.format("    std::string_view %s() {return std::string_view(begin()+fixed_size(), %s.raw_value()%s);}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset) + "\n" + String.format("    std::string_view %s() const {return std::string_view(cbegin()+fixed_size(), %s.raw_value()%s);}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset);

    } else {
      return String.format("    std::string_view %s() {return std::string_view(%s.end(), %s.raw_value()%s);}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset) + "\n" + String.format("    std::string_view %s() const {return std::string_view(%s.end(), %s.raw_value()%s);}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getPrevSibling(_context.getNode()), CONCEPTS.EBMessageMember$R), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset);
    }
  ...
  public static Object propertyMacro_GetValue_0_49(final PropertyMacroContext _context) {
    ...
    String offset = (isEmptyString(SPropertyOperations.getString(_context.getNode(), PROPS.offset$7HLp)) ? "" : "-" + SPropertyOperations.getString(_context.getNode(), PROPS.offset$7HLp));
    if (SNodeOperations.getParent(_context.getNode()) == SNodeOperations.getParent(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn))) {
      return String.format("        StrLenField(\"%s\", b\"\", length_from=lambda pkt:pkt.%s%s),", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset);
    } else {
      return String.format("        StrLenField(\"%s\", b\"\", length_from=lambda pkt:pkt.underlayer.%s%s),", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.size$7Hjn), PROPS.name$MnvL), offset);
    }
  }
  ...
  public static Object propertyMacro_GetValue_0_56(final PropertyMacroContext _context) {
    ...
    String size = String.format("static constexpr size_t fixed_size() noexcept {return sizeof(%s);}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL));
    String length = "size_t size() {return fixed_size();}";
    String clength = "size_t size() const {return fixed_size();}";
    String wire_size = String.format("static size_t wire_size(const char* p) {return reinterpret_cast<const %s*>(p)->size();}", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL));
    ...
    if ((boolean) EBMessage__BehaviorDescriptor.isNotFixedLength_id4Xeby11878t.invoke(_context.getNode())) {
      ...
      length = String.format("size_t size() {return %s().end()-begin();}", SPropertyOperations.getString(last, PROPS.name$MnvL));
      clength = String.format("size_t size() const {return %s().cend()-cbegin();}", SPropertyOperations.getString(last, PROPS.name$MnvL));
    }

    return String.format("    %s\n    %s\n    %s\n    %s\n    %s\n    %s\n    %s\n    %s\n", begin, cbegin, end, cend, size, length, clength, wire_size);
  }
  public static Object propertyMacro_GetValue_0_57(final PropertyMacroContext _context) {
    if (SPropertyOperations.getInteger(SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.EBProtocol$zC, false, false), PROPS.genType$AtJI) == 0) {
      ...
      return String.format("} [ size = %s, link_base: %s = %s ]\n", (SPropertyOperations.getInteger(_context.getNode(), PROPS.size$1BwP) == 0 ? "" : SPropertyOperations.getInteger(_context.getNode(), PROPS.size$1BwP)), ((SLinkOperations.getTarget(_context.getNode(), LINKS.base_link_type$L0s7) != null) ? SPropertyOperations.getString(SLinkOperations.getTarget(_context.getNode(), LINKS.base_link_type$L0s7), PROPS.name$MnvL) : ""), ((SLinkOperations.getTarget(_context.getNode(), LINKS.base_link_value$L0F8) != null) ? SLinkOperations.getTarget(_context.getNode(), LINKS.base_link_value$L0F8) : ""));
    }
  ...
  public static Object propertyMacro_GetValue_0_60(final PropertyMacroContext _context) {
    ...
    asString += String.format("\n    os << \"%s{\";", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL));
    ...
    for (SNode ele : ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.content$vVwC))) {
      if ((boolean) EBMessageMember__BehaviorDescriptor.isNotFixedLenMember_id_KNfA4Q0le.invoke(ele)) {
        asString += String.format("<< \"%2$s=\" << const_cast<%1$s&>(msg).%2$s() << \";\"\n       ", SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL), SPropertyOperations.getString(SNodeOperations.cast(ele, CONCEPTS.EBMessageMember$R), PROPS.name$MnvL));
      } else {
        asString += String.format("<< \"%1$s=\" << msg.%1$s << \";\"\n       ", SPropertyOperations.getString(SNodeOperations.cast(ele, CONCEPTS.EBMessageMember$R), PROPS.name$MnvL));
      }
    }
