...
public class GrammarCellsSubstituteMenu_EBMessageMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageMember() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2xww50_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageMember", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2xww50_a extends GrammarCellsSubstituteMenuPart {
    @Override
