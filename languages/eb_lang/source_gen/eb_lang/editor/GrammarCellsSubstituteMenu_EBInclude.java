...
public class GrammarCellsSubstituteMenu_EBInclude extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBInclude() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gjlr6v_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBInclude", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gjlr6v_a extends GrammarCellsSubstituteMenuPart {
    @Override
