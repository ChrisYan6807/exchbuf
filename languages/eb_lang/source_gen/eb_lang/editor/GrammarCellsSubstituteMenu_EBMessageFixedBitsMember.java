...
public class GrammarCellsSubstituteMenu_EBMessageFixedBitsMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageFixedBitsMember() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageFixedBitsMember", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_8injvn_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_8injvn_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageFixedBitsMember$57;
    }
  }
