...
public class GrammarCellsSubstituteMenu_EBMessageMemberFunc extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageMemberFunc() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3d79k6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageMemberFunc", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3d79k6_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageMemberFunc$wK;
    }
  }
