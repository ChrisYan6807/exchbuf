...
public class GrammarCellsSubstituteMenu_EBPrimitive extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBPrimitive() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBPrimitive", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_l4hjjb_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_l4hjjb_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBPrimitive$gU;
    }
  }
