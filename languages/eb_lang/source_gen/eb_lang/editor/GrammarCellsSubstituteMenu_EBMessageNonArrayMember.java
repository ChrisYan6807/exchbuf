...
public class GrammarCellsSubstituteMenu_EBMessageNonArrayMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageNonArrayMember() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xwklje_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageNonArrayMember", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xwklje_a extends GrammarCellsSubstituteMenuPart {
    @Override
