...
public class GrammarCellsSubstituteMenu_EBMessageMemberVarNoType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageMemberVarNoType() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageMemberVarNoType", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_aqlzbh_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_aqlzbh_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageMemberVarNoType$TI;
    }
  }
