...
public class GrammarCellsSubstituteMenu_EBMessage extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessage() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8dldp3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessage", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8dldp3_a extends GrammarCellsSubstituteMenuPart {
    @Override
