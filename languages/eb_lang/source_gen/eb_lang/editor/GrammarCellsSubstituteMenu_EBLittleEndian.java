...
public class GrammarCellsSubstituteMenu_EBLittleEndian extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBLittleEndian() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_sm0jat_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBLittleEndian", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_sm0jat_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBLittleEndian$e5;
    }
  }
