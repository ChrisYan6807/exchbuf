...
public class GrammarCellsSubstituteMenu_EBBitField extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBBitField() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_nvtnf7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBBitField", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_nvtnf7_a extends GrammarCellsSubstituteMenuPart {
    @Override
