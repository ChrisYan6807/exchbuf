    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item, _context) {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SPropertyOperations.assign(num, PROPS.value$zter, pattern);
          return num;
        }
        @Override
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item, _context) {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          if (pattern.matches("'")) {
            SPropertyOperations.assign(charNode, PROPS.value$zter, "");
          } else {
            SPropertyOperations.assign(charNode, PROPS.value$zter, pattern);
          }
          return charNode;
        }
        @Override
