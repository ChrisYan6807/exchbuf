...
public class GrammarCellsSubstituteMenu_EBImportPrimitive extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBImportPrimitive() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bbreyc_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBImportPrimitive", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bbreyc_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBImportPrimitive$gU;
    }
  }
