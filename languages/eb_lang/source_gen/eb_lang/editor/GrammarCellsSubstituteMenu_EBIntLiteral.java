...
public class GrammarCellsSubstituteMenu_EBIntLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBIntLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_335uvw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBIntLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_335uvw_a extends GrammarCellsSubstituteMenuPart {
    @Override
