...
public class GrammarCellsSubstituteMenu_EBEndian extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBEndian() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lcrfm2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBEndian", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lcrfm2_a extends GrammarCellsSubstituteMenuPart {
    @Override
