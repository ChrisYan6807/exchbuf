...
public class GrammarCellsSubstituteMenu_EBFixedLenghString extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBFixedLenghString() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_m8yyva_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBFixedLenghString", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_m8yyva_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBFixedLenghString$Ss;
    }
  }
