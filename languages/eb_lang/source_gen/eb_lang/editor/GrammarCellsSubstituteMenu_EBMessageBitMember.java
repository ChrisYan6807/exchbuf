...
public class GrammarCellsSubstituteMenu_EBMessageBitMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageBitMember() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageBitMember", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_e81ef0_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_e81ef0_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageBitMember$57;
    }
  }
