...
public class GrammarCellsSubstituteMenu_EBIntKVPair extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBIntKVPair() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_y2ty7x_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBIntKVPair", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_y2ty7x_a extends GrammarCellsSubstituteMenuPart {
    @Override
