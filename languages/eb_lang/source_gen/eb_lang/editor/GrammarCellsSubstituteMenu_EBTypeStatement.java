...
public class GrammarCellsSubstituteMenu_EBTypeStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBTypeStatement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ox2nxa_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBTypeStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ox2nxa_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBTypeStatement$o0;
    }
  }
