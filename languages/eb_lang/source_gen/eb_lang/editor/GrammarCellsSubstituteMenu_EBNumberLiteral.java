...
public class GrammarCellsSubstituteMenu_EBNumberLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBNumberLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_kvca6e_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBNumberLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_kvca6e_a extends GrammarCellsSubstituteMenuPart {
    @Override
