...
public class GrammarCellsSubstituteMenu_EBIntType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBIntType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_go2e0o_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBIntType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_go2e0o_a extends GrammarCellsSubstituteMenuPart {
    @Override
