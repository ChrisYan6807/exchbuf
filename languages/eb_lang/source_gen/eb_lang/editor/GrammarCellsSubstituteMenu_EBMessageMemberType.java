...
public class GrammarCellsSubstituteMenu_EBMessageMemberType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageMemberType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3dbrz5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageMemberType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3dbrz5_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageMemberType$X_;
    }
  }
