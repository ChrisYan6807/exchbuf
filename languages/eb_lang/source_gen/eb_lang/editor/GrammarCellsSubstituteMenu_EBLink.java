...
public class GrammarCellsSubstituteMenu_EBLink extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBLink() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBLink", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ct6zo9_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ct6zo9_a extends GrammarCellsSubstituteMenuPart {
    @Override
