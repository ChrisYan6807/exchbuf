...
public class GrammarCellsSubstituteMenu_EBIIdentifierConcept extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBIIdentifierConcept() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_s88bpj_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBIIdentifierConcept", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_s88bpj_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBIIdentifierConcept$uk;
    }
  }
