...
public class GrammarCellsSubstituteMenu_EBEnum extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBEnum() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ct4t5p_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBEnum", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ct4t5p_a extends GrammarCellsSubstituteMenuPart {
    @Override
