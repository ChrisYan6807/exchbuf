...
public class GrammarCellsSubstituteMenu_EBProtocol extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBProtocol() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6qm4vc_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBProtocol", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6qm4vc_a extends GrammarCellsSubstituteMenuPart {
    @Override
