...
public class GrammarCellsSubstituteMenu_EBMessageBaseInitializer extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageBaseInitializer() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gptc0x_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageBaseInitializer", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gptc0x_a extends GrammarCellsSubstituteMenuPart {
    @Override
