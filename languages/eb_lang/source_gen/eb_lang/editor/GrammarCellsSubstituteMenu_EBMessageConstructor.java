...
public class GrammarCellsSubstituteMenu_EBMessageConstructor extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageConstructor() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8y543a_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageConstructor", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8y543a_a extends GrammarCellsSubstituteMenuPart {
    @Override
