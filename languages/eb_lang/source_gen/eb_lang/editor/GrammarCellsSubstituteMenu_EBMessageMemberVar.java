...
public class GrammarCellsSubstituteMenu_EBMessageMemberVar extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageMemberVar() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_tw926n_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageMemberVar", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_tw926n_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageMemberVar$_K;
    }
  }
