...
public class EBMessageBitMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBMessageBitMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBMessageBitMember$57, initContext);
    record(new RD1(this));
  }
      ...
      return new BaseScopeProvider() {
        ...
        public Scope createScope(final ReferenceConstraintsContext _context) {
          ...
          for (SNode n : typeStatements) {
            if (SNodeOperations.isInstanceOf(n, CONCEPTS.EBEnum$37) || SNodeOperations.isInstanceOf(n, CONCEPTS.EBImportPrimitive$gU) && SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(n, CONCEPTS.EBImportPrimitive$gU), LINKS.type$zVeR), CONCEPTS.EBIntType$ej)) {
