          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            ...
            if ((msg != null)) {
              ...
              if ((ctor != null)) {
                ...
                if ((msgType != null)) {
                  LogContext.with(EBMessageBaseInitializer_Constraints.class, null, null, null).debug("msgType is not null, populate values");
                  return ListScope.forNamedElements(SLinkOperations.getChildren(msgType, LINKS.values$_zmn));
                } else {
                  LogContext.with(EBMessageBaseInitializer_Constraints.class, null, null, null).debug("msgType is null");
                }
              } else {
                LogContext.with(EBMessageBaseInitializer_Constraints.class, null, null, null).debug("constrctor is null");
              }
            } else {
              LogContext.with(EBMessageBaseInitializer_Constraints.class, null, null, null).debug("base message is null.");
            }
