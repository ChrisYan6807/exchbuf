...
public class EBMessagePresenceFieldMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBMessagePresenceFieldMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBMessagePresenceFieldMember$Z, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.presence_map$Zjwo, container, true, false);
    }
    @Nullable
    @Override
