...
public class EBMessageEntryMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBMessageEntryMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBMessageEntryMember$fS, initContext);
    record(new RD1(this));
  }
    ...
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public SNodeReference getSearchScopeValidatorNode() {
          return new SNodePointer("r:3627401c-d045-43be-a0d6-b80453db7eba(eb_lang.constraints)", "6284687853304310221");
        }
        @Override
