...
public class EBMessage_Constraints extends BaseConstraintsDescriptor {
  private static final Logger LOG = LogManager.getLogger(EBMessage_Constraints.class);
        ...
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            ...
            for (SNode include_statement : includes) {
              LoggingRuntime.logMsgView(Level.DEBUG, "iterate EBInclude", EBMessage_Constraints.class, null, null);
              ...
              LoggingRuntime.logMsgView(Level.DEBUG, "done EBInclude", EBMessage_Constraints.class, null, null);
            }
            ...
            for (SNode n : typeStatements) {
              LoggingRuntime.logMsgView(Level.DEBUG, "iterate EBTypeStatement", EBMessage_Constraints.class, null, null);
              ListSequence.fromList(statements).addElement(n);
              LoggingRuntime.logMsgView(Level.DEBUG, "Done EBTypeStatement", EBMessage_Constraints.class, null, null);
            }

            LoggingRuntime.logMsgView(Level.INFO, "calculated type statements: " + statements.toString(), EBMessage_Constraints.class, null, null);
