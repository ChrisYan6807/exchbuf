...
public class EBMessageVarArrayMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBMessageVarArrayMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBMessageVarArrayMember$o, initContext);
    record(new RD1(this));
    record(new RD2(this));
  }
      ...
      return new BaseScopeProvider() {
        ...
        public Scope createScope(final ReferenceConstraintsContext _context) {
          ...
          for (SNode n : entryStatements) {
            if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(n, LINKS.type$zO4N), CONCEPTS.EBPrimitive$gU)) {
              if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(n, LINKS.type$zO4N), CONCEPTS.EBPrimitive$gU), LINKS.type$zVeR), CONCEPTS.EBIntType$ej)) {
                ListSequence.fromList(statements).addElement(n);
              }
            }
          }
