...
public class EBMessageBlockMember_Constraints extends BaseConstraintsDescriptor {
  private static final Logger LOG = LogManager.getLogger(EBMessageBlockMember_Constraints.class);
        ...
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            ...
            for (SNode n : entryStatements) {
              LoggingRuntime.logMsgView(Level.DEBUG, "iterate EBMessageEntryMember", EBMessageBlockMember_Constraints.class, null, null);
              ListSequence.fromList(statements).addElement(n);
              LoggingRuntime.logMsgView(Level.DEBUG, "Done EBMessageEntryMember", EBMessageBlockMember_Constraints.class, null, null);
            }
