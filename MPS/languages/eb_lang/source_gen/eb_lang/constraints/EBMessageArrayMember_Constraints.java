...
public class EBMessageArrayMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBMessageArrayMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBMessageArrayMember$rb, initContext);
    record(new RD1(this));
  }
    ...
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public SNodeReference getSearchScopeValidatorNode() {
          return new SNodePointer("r:3627401c-d045-43be-a0d6-b80453db7eba(eb_lang.constraints)", "4586680865750550735");
        }
        @Override
