...
public class EBBitFieldMember_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EBBitFieldMember_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EBBitFieldMember$_K, initContext);
    record(new RD1(this));
    record(new RD2(this));
  }
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.enum$iBH6, container, true, false);
    }
    @Nullable
    @Override
  ...
  /*package*/ static final class RD2 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD2(ConstraintsDescriptor container) {
      super(LINKS.default$Qsog, container, true, false);
    }
    @Nullable
    @Override
    public ReferenceScopeProvider getScopeProvider() {
