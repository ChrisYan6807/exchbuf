...
public final class EBInt32__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x59242254602f42f3L, 0xab3adc203eb4cc03L, 0x726a4e86e24124afL, "eb_lang.structure.EBInt32");
  ...
  /*package*/ static String fmt_id4GpIFxqoQnK(@NotNull SNode __thisNode__) {
    return EBIntType__BehaviorDescriptor.byteOrderChar_id4GpIFxqp7uZ.invoke(__thisNode__) + "i";
  }

  /*package*/ EBInt32__BehaviorDescriptor() {
  }
