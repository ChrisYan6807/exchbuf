...
public class GrammarCellsSubstituteMenu_EBMessageVarStrMember extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EBMessageVarStrMember() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EBMessageVarStrMember", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_93v2ix_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_93v2ix_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EBMessageVarStrMember$P3;
    }
  }
