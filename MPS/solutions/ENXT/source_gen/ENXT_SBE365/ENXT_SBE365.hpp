...
using char_t = LittleEndian<char, std::numeric_limits<int8_t>::min(), std::numeric_limits<int8_t>::max(), 0_i8>;
...
using uint16 = LittleEndian<uint16_t, std::numeric_limits<uint16_t>::min(), std::numeric_limits<uint16_t>::max(), 0_u16>;
using int16 = LittleEndian<int16_t, std::numeric_limits<int16_t>::min(), std::numeric_limits<int16_t>::max(), 0_i16>;
using uint32 = LittleEndian<uint32_t, std::numeric_limits<uint32_t>::min(), std::numeric_limits<uint32_t>::max(), 0_u32>;
using int32 = LittleEndian<int32_t, std::numeric_limits<int32_t>::min(), std::numeric_limits<int32_t>::max(), 0_i32>;
using uint64 = LittleEndian<uint64_t, std::numeric_limits<uint64_t>::min(), std::numeric_limits<uint64_t>::max(), 0_u64>;
using int64 = LittleEndian<int64_t, std::numeric_limits<int64_t>::min(), std::numeric_limits<int64_t>::max(), 0_i64>;

using unsigned_char = LittleEndian<uint8_t, 0_u8, 254_u8, 255_u8, 0, true>;
using i8 = LittleEndian<int8_t, -127_i8, 127_i8, -128_i8, 0, true>;
using u16 = LittleEndian<uint16_t, 0_u16, 65534_u16, 65535_u16>;
using u32 = LittleEndian<uint32_t, 0_u32, 4294967294_u32, 4294967295_u32>;
using u64 = LittleEndian<uint64_t, 0_u64, 18446744073709551614_u64, 18446744073709551615_u64>;
using i32 = LittleEndian<int32_t, -2147483647_i32, 2147483647_i32, -2147483648_i32>;
using i64 = LittleEndian<int64_t, -9223372036854775807_i64, 9223372036854775807_i64, -9223372036854775808_i64>;
using char1 = LittleEndian<char, std::numeric_limits<int8_t>::min(), std::numeric_limits<int8_t>::max(), 0_i8>;
...
struct TemplateIdType {
    ...
    static constexpr const char* name() {return "TemplateIdType";}
...
struct MessageHeader {
    uint16 frameLength;
    uint16 blockLength;
    TemplateIdType templateId{TemplateIdType::NewOrder};
    uint16 schemaId{0_u16};
    uint16 version{365_u16};
    ...
    static constexpr size_t fixed_size() noexcept {return sizeof(MessageHeader);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MessageHeader*>(p)->size();}
};
#pragma pack()
...
struct groupSizeEncoding {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(groupSizeEncoding);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const groupSizeEncoding*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const groupSizeEncoding& msg) {
    os << "groupSizeEncoding{";
...
struct groupSizeEncoding16 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(groupSizeEncoding16);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const groupSizeEncoding16*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const groupSizeEncoding16& msg) {
    os << "groupSizeEncoding16{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
       << "}";
    return os;
...
struct RFQType_enum {
    ...
    static constexpr const char* name() {return "RFQType_enum";}
...
struct ExecutionInstruction_set {
    ...
    STPRestingOrder getSTPRestingOrder() const {
        auto v = bits&get_mask<uint8_t, 0, 1>;
        return STPRestingOrder(uint8_t(v));
    }
    ...
    STPIncomingOrder getSTPIncomingOrder() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return STPIncomingOrder(uint8_t(v));
    }
    ...
    DisclosedQuantityRandomization getDisclosedQuantityRandomization() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return DisclosedQuantityRandomization(uint8_t(v));
    }
    ...
    DisabledCancelOnDisconnectIndicator getDisabledCancelOnDisconnectIndicator() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return DisabledCancelOnDisconnectIndicator(uint8_t(v));
    }
    ...
    RFQAnswer getRFQAnswer() const {
        auto v = bits&get_mask<uint8_t, 4, 1>;
        v >>= 4;
        return RFQAnswer(uint8_t(v));
    }
    ...
    RFQConfirmation getRFQConfirmation() const {
        auto v = bits&get_mask<uint8_t, 5, 1>;
        v >>= 5;
        return RFQConfirmation(uint8_t(v));
    }
    ...
    ConditionalOrder getConditionalOrder() const {
        auto v = bits&get_mask<uint8_t, 6, 1>;
        v >>= 6;
        return ConditionalOrder(uint8_t(v));
    }
    ...
    STPBothOrders getSTPBothOrders() const {
        auto v = bits&get_mask<uint8_t, 7, 1>;
        v >>= 7;
        return STPBothOrders(uint8_t(v));
    }
...
struct DarkSTPIndicator {
    ...
    static constexpr const char* name() {return "DarkSTPIndicator";}
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
...
struct DarkPassiveOrderIndicator {
    ...
    static constexpr const char* name() {return "DarkPassiveOrderIndicator";}
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
...
struct DarkExecutionInstruction_set {
    ...
    DarkIndicator getDarkIndicator() const {
        auto v = bits&get_mask<uint8_t, 0, 1>;
        return DarkIndicator(uint8_t(v));
    }
    ...
    DeferredTradeIndicator getDeferredTradeIndicator() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return DeferredTradeIndicator(uint8_t(v));
    }
    ...
    DisplayedOrderInteraction getDisplayedOrderInteraction() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return DisplayedOrderInteraction(uint8_t(v));
    }
    ...
    SweepOrderIndicator getSweepOrderIndicator() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return SweepOrderIndicator(uint8_t(v));
    }
    ...
    MinimumQuantityType getMinimumQuantityType() const {
        auto v = bits&get_mask<uint8_t, 4, 1>;
        v >>= 4;
        return MinimumQuantityType(uint8_t(v));
    }
    ...
    DarkSTPIndicator getDarkSTPIndicator() const {
        auto v = bits&get_mask<uint8_t, 5, 1>;
        v >>= 5;
        return DarkSTPIndicator(uint8_t(v));
    }
    ...
    DarkPassiveOrderIndicator getDarkPassiveOrderIndicator() const {
        auto v = bits&get_mask<uint8_t, 6, 1>;
        v >>= 6;
        return DarkPassiveOrderIndicator(uint8_t(v));
    }
...
struct AckQualifiers_set {
    ...
    QueueIndicator getQueueIndicator() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return QueueIndicator(uint8_t(v));
    }
    ...
    RequestWithClientOrderID getRequestWithClientOrderID() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return RequestWithClientOrderID(uint8_t(v));
    }
    ...
    UseOfCrossPartition getUseOfCrossPartition() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return UseOfCrossPartition(uint8_t(v));
    }
    ...
    Internal1 getInternal1() const {
        auto v = bits&get_mask<uint8_t, 4, 1>;
        v >>= 4;
        return Internal1(uint8_t(v));
    }
    ...
    Internal2 getInternal2() const {
        auto v = bits&get_mask<uint8_t, 5, 1>;
        v >>= 5;
        return Internal2(uint8_t(v));
    }
    ...
    ExecutionUponEntryFlagEnabled getExecutionUponEntryFlagEnabled() const {
        auto v = bits&get_mask<uint8_t, 6, 1>;
        v >>= 6;
        return ExecutionUponEntryFlagEnabled(uint8_t(v));
    }
    ...
    ExecutedUponEntryFlag getExecutedUponEntryFlag() const {
        auto v = bits&get_mask<uint8_t, 7, 1>;
        v >>= 7;
        return ExecutedUponEntryFlag(uint8_t(v));
    }
...
struct MiFIDIndicators_set {
    ...
    DEAIndicator getDEAIndicator() const {
        auto v = bits&get_mask<uint8_t, 0, 1>;
        return DEAIndicator(uint8_t(v));
    }
    ...
    InvestmentAlgoIndicator getInvestmentAlgoIndicator() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return InvestmentAlgoIndicator(uint8_t(v));
    }
    ...
    ExecutionAlgoIndicator getExecutionAlgoIndicator() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return ExecutionAlgoIndicator(uint8_t(v));
    }
    ...
    CommodityDerivativeIndicator getCommodityDerivativeIndicator() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return CommodityDerivativeIndicator(uint8_t(v));
    }
    ...
    DeferralIndicator getDeferralIndicator() const {
        auto v = bits&get_mask<uint8_t, 4, 1>;
        v >>= 4;
        return DeferralIndicator(uint8_t(v));
    }
    ...
    FRMARAMPLP getFRMARAMPLP() const {
        auto v = bits&get_mask<uint8_t, 5, 1>;
        v >>= 5;
        return FRMARAMPLP(uint8_t(v));
    }
...
struct OpenClose_set {
    ...
    FieldActivelyUsed getFieldActivelyUsed() const {
        auto v = bits&get_mask<uint16_t, 0, 1>;
        return FieldActivelyUsed(uint16_t(v));
    }
...
struct TradeQualifier_set {
    ...
    UncrossingTrade getUncrossingTrade() const {
        auto v = bits&get_mask<uint8_t, 0, 1>;
        return UncrossingTrade(uint8_t(v));
    }
    ...
    FirstTradePrice getFirstTradePrice() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return FirstTradePrice(uint8_t(v));
    }
    ...
    PassiveOrder getPassiveOrder() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return PassiveOrder(uint8_t(v));
    }
    ...
    AggressiveOrder getAggressiveOrder() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return AggressiveOrder(uint8_t(v));
    }
    ...
    TradeCreationByMarketOperations getTradeCreationByMarketOperations() const {
        auto v = bits&get_mask<uint8_t, 4, 1>;
        v >>= 4;
        return TradeCreationByMarketOperations(uint8_t(v));
    }
    ...
    NAVTradeExpressedInBps getNAVTradeExpressedInBps() const {
        auto v = bits&get_mask<uint8_t, 5, 1>;
        v >>= 5;
        return NAVTradeExpressedInBps(uint8_t(v));
    }
    ...
    NAVTradeExpressedInPriceCurrency getNAVTradeExpressedInPriceCurrency() const {
        auto v = bits&get_mask<uint8_t, 6, 1>;
        v >>= 6;
        return NAVTradeExpressedInPriceCurrency(uint8_t(v));
    }
    ...
    DeferredPublication getDeferredPublication() const {
        auto v = bits&get_mask<uint8_t, 7, 1>;
        v >>= 7;
        return DeferredPublication(uint8_t(v));
    }
...
struct TradingSessionValidity_set {
    ...
    Session1 getSession1() const {
        auto v = bits&get_mask<uint8_t, 0, 1>;
        return Session1(uint8_t(v));
    }
    ...
    Session2 getSession2() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return Session2(uint8_t(v));
    }
    ...
    Session3 getSession3() const {
        auto v = bits&get_mask<uint8_t, 2, 1>;
        v >>= 2;
        return Session3(uint8_t(v));
    }
    ...
    Session4 getSession4() const {
        auto v = bits&get_mask<uint8_t, 3, 1>;
        v >>= 3;
        return Session4(uint8_t(v));
    }
...
struct MMPExecutionType_set {
    ...
    Acknowledgement getAcknowledgement() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return Acknowledgement(uint8_t(v));
    }
...
struct CallMode {
    ...
    static constexpr const char* name() {return "CallMode";}
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
...
struct ContinuousMode {
    ...
    static constexpr const char* name() {return "ContinuousMode";}
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), });
...
struct MarketCondition_set {
    ...
    ContinuousMode getContinuousMode() const {
        auto v = bits&get_mask<uint8_t, 1, 1>;
        v >>= 1;
        return ContinuousMode(uint8_t(v));
    }
...
struct TargetCounterparties_set {
    ...
    EuronextDataDriven getEuronextDataDriven() const {
        auto v = bits&get_mask<uint16_t, 0, 1>;
        return EuronextDataDriven(uint16_t(v));
    }
    ...
    InterestLists getInterestLists() const {
        auto v = bits&get_mask<uint16_t, 1, 1>;
        v >>= 1;
        return InterestLists(uint16_t(v));
    }
    ...
    Holdings getHoldings() const {
        auto v = bits&get_mask<uint16_t, 2, 1>;
        v >>= 2;
        return Holdings(uint16_t(v));
    }
    ...
    BuySide getBuySide() const {
        auto v = bits&get_mask<uint16_t, 3, 1>;
        v >>= 3;
        return BuySide(uint16_t(v));
    }
    ...
    SellSide getSellSide() const {
        auto v = bits&get_mask<uint16_t, 4, 1>;
        v >>= 4;
        return SellSide(uint16_t(v));
    }
    ...
    QualityOfSellSideCounterparty getQualityOfSellSideCounterparty() const {
        auto v = bits&get_mask<uint16_t, 5, 1>;
        v >>= 5;
        return QualityOfSellSideCounterparty(uint16_t(v));
    }
    ...
    LocalCommunityOfSpecialistAMS getLocalCommunityOfSpecialistAMS() const {
        auto v = bits&get_mask<uint16_t, 6, 1>;
        v >>= 6;
        return LocalCommunityOfSpecialistAMS(uint16_t(v));
    }
    ...
    LocalCommunityOfSpecialistPAR getLocalCommunityOfSpecialistPAR() const {
        auto v = bits&get_mask<uint16_t, 7, 1>;
        v >>= 7;
        return LocalCommunityOfSpecialistPAR(uint16_t(v));
    }
    ...
    LocalCommunityOfSpecialistBRU getLocalCommunityOfSpecialistBRU() const {
        auto v = bits&get_mask<uint16_t, 8, 1>;
        v >>= 8;
        return LocalCommunityOfSpecialistBRU(uint16_t(v));
    }
    ...
    LocalCommunityOfSpecialistLIS getLocalCommunityOfSpecialistLIS() const {
        auto v = bits&get_mask<uint16_t, 9, 1>;
        v >>= 9;
        return LocalCommunityOfSpecialistLIS(uint16_t(v));
    }
...
struct NewOrder_FreeTextSection {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_FreeTextSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_FreeTextSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_FreeTextSection& msg) {
    os << "NewOrder_FreeTextSection{";
...
struct NewOrder_FreeTextSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_FreeTextSection> data() {return BlockRef<NewOrder_FreeTextSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_FreeTextSection> data() const {return BlockRef<NewOrder_FreeTextSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_FreeTextSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_FreeTextSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_FreeTextSection_Composite& msg) {
    os << "NewOrder_FreeTextSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_MiFIDShortcodes {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_MiFIDShortcodes);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_MiFIDShortcodes*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_MiFIDShortcodes& msg) {
    os << "NewOrder_MiFIDShortcodes{";
...
struct NewOrder_MiFIDShortcodes_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_MiFIDShortcodes> data() {return BlockRef<NewOrder_MiFIDShortcodes>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_MiFIDShortcodes> data() const {return BlockRef<NewOrder_MiFIDShortcodes>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_MiFIDShortcodes_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_MiFIDShortcodes_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_MiFIDShortcodes_Composite& msg) {
    os << "NewOrder_MiFIDShortcodes_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_OptionalFields {
    ...
    UndisclosedIcebergType_enum undisclosedIcebergType{UndisclosedIcebergType_enum::Limit};
    TriggeredStopTimeInForce_enum stopTriggeredTimeInForce{TriggeredStopTimeInForce_enum::Day};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_OptionalFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_OptionalFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_OptionalFields& msg) {
    os << "NewOrder_OptionalFields{";
...
struct NewOrder_OptionalFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_OptionalFields> data() {return BlockRef<NewOrder_OptionalFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_OptionalFields> data() const {return BlockRef<NewOrder_OptionalFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_OptionalFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_OptionalFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_OptionalFields_Composite& msg) {
    os << "NewOrder_OptionalFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_ClearingFields {
    ...
    TechnicalOrigin_enum technicalOrigin{TechnicalOrigin_enum::Index_trading_arbitrage};
    OpenClose_set openClose;
    ClearingInstruction_enum clearingInstruction{ClearingInstruction_enum::Process_normally__formerly_Systematic_posting_};
    AccountTypeCross_enum accountTypeCross{AccountTypeCross_enum::Client};
    TradingCapacityCross_enum tradingCapacityCross{TradingCapacityCross_enum::Dealing_on_own_account};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_ClearingFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_ClearingFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_ClearingFields& msg) {
    os << "NewOrder_ClearingFields{";
...
struct NewOrder_ClearingFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_ClearingFields> data() {return BlockRef<NewOrder_ClearingFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_ClearingFields> data() const {return BlockRef<NewOrder_ClearingFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_ClearingFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_ClearingFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_ClearingFields_Composite& msg) {
    os << "NewOrder_ClearingFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_NotUsedGroup1& msg) {
    os << "NewOrder_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct NewOrder_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_NotUsedGroup1> data() {return BlockRef<NewOrder_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_NotUsedGroup1> data() const {return BlockRef<NewOrder_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_NotUsedGroup1_Composite& msg) {
    os << "NewOrder_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_NotUsedGroup2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_NotUsedGroup2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_NotUsedGroup2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_NotUsedGroup2& msg) {
    os << "NewOrder_NotUsedGroup2{";
    os << "}";
    return os;
}
#pragma pack(1)
struct NewOrder_NotUsedGroup2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_NotUsedGroup2> data() {return BlockRef<NewOrder_NotUsedGroup2>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_NotUsedGroup2> data() const {return BlockRef<NewOrder_NotUsedGroup2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_NotUsedGroup2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_NotUsedGroup2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_NotUsedGroup2_Composite& msg) {
    os << "NewOrder_NotUsedGroup2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_AdditionalInfos {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_AdditionalInfos);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_AdditionalInfos*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_AdditionalInfos& msg) {
    os << "NewOrder_AdditionalInfos{";
...
struct NewOrder_AdditionalInfos_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_AdditionalInfos> data() {return BlockRef<NewOrder_AdditionalInfos>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_AdditionalInfos> data() const {return BlockRef<NewOrder_AdditionalInfos>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_AdditionalInfos_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_AdditionalInfos_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_AdditionalInfos_Composite& msg) {
    os << "NewOrder_AdditionalInfos_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder_OptionalIDs {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_OptionalIDs);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_OptionalIDs*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_OptionalIDs& msg) {
    os << "NewOrder_OptionalIDs{";
    os << "lPID=" << msg.lPID << ";"
       << "}";
    return os;
}
...
struct NewOrder_OptionalIDs_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewOrder_OptionalIDs> data() {return BlockRef<NewOrder_OptionalIDs>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewOrder_OptionalIDs> data() const {return BlockRef<NewOrder_OptionalIDs>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder_OptionalIDs_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewOrder_OptionalIDs_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewOrder_OptionalIDs_Composite& msg) {
    os << "NewOrder_OptionalIDs_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewOrder : MessageHeader {
    ...
    i64 clientOrderID;
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    OrderSide_enum orderSide{OrderSide_enum::Buy};
    OrderType_enum orderType{OrderType_enum::Market};
    TimeInForce_enum timeInForce{TimeInForce_enum::Day};
    i64 orderPx;
    u64 orderQty;
    i32 executionWithinFirmShortCode;
    TradingCapacity_enum tradingCapacity{TradingCapacity_enum::Dealing_on_own_account};
    AccountType_enum accountType{AccountType_enum::Client};
    LPRole_enum lPRole{LPRole_enum::Liquidity_Provider_or_Market_Maker};
    ...
    i64 iOIID;
    FloatingRef<NewOrder_FreeTextSection_Composite> FreeTextSection() {return FloatingRef<NewOrder_FreeTextSection_Composite>(begin() + fixed_size());}
    FloatingRef<NewOrder_FreeTextSection_Composite> FreeTextSection() const {return FloatingRef<NewOrder_FreeTextSection_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<NewOrder_MiFIDShortcodes_Composite> MiFIDShortcodes() const {return FloatingRef<NewOrder_MiFIDShortcodes_Composite>(FreeTextSection().cend());}
    ...
    FloatingRef<NewOrder_OptionalFields_Composite> OptionalFields() const {return FloatingRef<NewOrder_OptionalFields_Composite>(MiFIDShortcodes().cend());}
    ...
    FloatingRef<NewOrder_ClearingFields_Composite> ClearingFields() const {return FloatingRef<NewOrder_ClearingFields_Composite>(OptionalFields().cend());}
    ...
    FloatingRef<NewOrder_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<NewOrder_NotUsedGroup1_Composite>(ClearingFields().cend());}
    ...
    FloatingRef<NewOrder_NotUsedGroup2_Composite> NotUsedGroup2() const {return FloatingRef<NewOrder_NotUsedGroup2_Composite>(NotUsedGroup1().cend());}
    ...
    FloatingRef<NewOrder_AdditionalInfos_Composite> AdditionalInfos() const {return FloatingRef<NewOrder_AdditionalInfos_Composite>(NotUsedGroup2().cend());}
    ...
    FloatingRef<NewOrder_OptionalIDs_Composite> OptionalIDs() const {return FloatingRef<NewOrder_OptionalIDs_Composite>(AdditionalInfos().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewOrder);}
    size_t size() {return OptionalIDs().end()-begin();}
    size_t size() const {return OptionalIDs().cend()-cbegin();}
...
inline std::ostream& operator<<(std::ostream& os, const NewOrder& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "iOIID=" << msg.iOIID << ";"
       << "FreeTextSection=" << const_cast<NewOrder&>(msg).FreeTextSection() << ";"
       << "MiFIDShortcodes=" << const_cast<NewOrder&>(msg).MiFIDShortcodes() << ";"
       << "OptionalFields=" << const_cast<NewOrder&>(msg).OptionalFields() << ";"
       << "ClearingFields=" << const_cast<NewOrder&>(msg).ClearingFields() << ";"
       << "NotUsedGroup1=" << const_cast<NewOrder&>(msg).NotUsedGroup1() << ";"
       << "NotUsedGroup2=" << const_cast<NewOrder&>(msg).NotUsedGroup2() << ";"
       << "AdditionalInfos=" << const_cast<NewOrder&>(msg).AdditionalInfos() << ";"
       << "OptionalIDs=" << const_cast<NewOrder&>(msg).OptionalIDs() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct Ack_MiFIDFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Ack_MiFIDFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Ack_MiFIDFields*>(p)->size();}
};
#pragma pack()
...
struct Ack_MiFIDFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Ack_MiFIDFields> data() {return BlockRef<Ack_MiFIDFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Ack_MiFIDFields> data() const {return BlockRef<Ack_MiFIDFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Ack_MiFIDFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Ack_MiFIDFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Ack_MiFIDFields_Composite& msg) {
    os << "Ack_MiFIDFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Ack : MessageHeader {
    ...
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    OrderSide_enum orderSide{OrderSide_enum::Buy};
    AckType_enum ackType{AckType_enum::New_Order_Ack};
    AckPhase_enum ackPhase{AckPhase_enum::Continuous_Trading_Phase};
    u64 orderID;
    u64 orderPriority;
    i64 orderPx;
    u64 orderQty;
    ...
    FloatingRef<Ack_MiFIDFields_Composite> MiFIDFields() {return FloatingRef<Ack_MiFIDFields_Composite>(begin() + fixed_size());}
    FloatingRef<Ack_MiFIDFields_Composite> MiFIDFields() const {return FloatingRef<Ack_MiFIDFields_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Ack);}
    size_t size() {return MiFIDFields().end()-begin();}
    size_t size() const {return MiFIDFields().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Ack*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Ack& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "MiFIDFields=" << const_cast<Ack&>(msg).MiFIDFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct Fill_OptionalFieldsFill {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_OptionalFieldsFill);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_OptionalFieldsFill*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_OptionalFieldsFill& msg) {
    os << "Fill_OptionalFieldsFill{";
...
struct Fill_OptionalFieldsFill_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Fill_OptionalFieldsFill> data() {return BlockRef<Fill_OptionalFieldsFill>(begin()+fixed_size(), numInGroup);}
    BlockRef<Fill_OptionalFieldsFill> data() const {return BlockRef<Fill_OptionalFieldsFill>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_OptionalFieldsFill_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_OptionalFieldsFill_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_OptionalFieldsFill_Composite& msg) {
    os << "Fill_OptionalFieldsFill_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Fill_StrategyFields {
    ...
    u64 legLastQty;
    u32 legInstrumentID;
    LegSide_enum legSide{LegSide_enum::Buy};
    u32 executionID;
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_StrategyFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_StrategyFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_StrategyFields& msg) {
    os << "Fill_StrategyFields{";
...
struct Fill_StrategyFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Fill_StrategyFields> data() {return BlockRef<Fill_StrategyFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Fill_StrategyFields> data() const {return BlockRef<Fill_StrategyFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_StrategyFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_StrategyFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_StrategyFields_Composite& msg) {
    os << "Fill_StrategyFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Fill_MiFIDFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_MiFIDFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_MiFIDFields*>(p)->size();}
};
#pragma pack()
...
struct Fill_MiFIDFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Fill_MiFIDFields> data() {return BlockRef<Fill_MiFIDFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Fill_MiFIDFields> data() const {return BlockRef<Fill_MiFIDFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_MiFIDFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_MiFIDFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_MiFIDFields_Composite& msg) {
    os << "Fill_MiFIDFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Fill_OptionalFieldsDerivatives {
    i64 evaluatedPrice;
    MessagePriceNotation_enum messagePriceNotation{MessagePriceNotation_enum::Price};
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_OptionalFieldsDerivatives);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_OptionalFieldsDerivatives*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_OptionalFieldsDerivatives& msg) {
    os << "Fill_OptionalFieldsDerivatives{";
...
struct Fill_OptionalFieldsDerivatives_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Fill_OptionalFieldsDerivatives> data() {return BlockRef<Fill_OptionalFieldsDerivatives>(begin()+fixed_size(), numInGroup);}
    BlockRef<Fill_OptionalFieldsDerivatives> data() const {return BlockRef<Fill_OptionalFieldsDerivatives>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill_OptionalFieldsDerivatives_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill_OptionalFieldsDerivatives_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill_OptionalFieldsDerivatives_Composite& msg) {
    os << "Fill_OptionalFieldsDerivatives_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Fill : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    FillOrderSide_enum orderSide{FillOrderSide_enum::Buy};
    TradeType_enum tradeType{TradeType_enum::Conventional_Trade};
    ...
    u64 leavesQty;
    u32 executionID;
    ExecutionPhase_enum executionPhase{ExecutionPhase_enum::Continuous_Trading_Phase};
    u32 lISTransactionID;
    unsigned_char eSCBMembership;
    char16 tradeUniqueIdentifier;
    FloatingRef<Fill_OptionalFieldsFill_Composite> OptionalFieldsFill() {return FloatingRef<Fill_OptionalFieldsFill_Composite>(begin() + fixed_size());}
    FloatingRef<Fill_OptionalFieldsFill_Composite> OptionalFieldsFill() const {return FloatingRef<Fill_OptionalFieldsFill_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<Fill_StrategyFields_Composite> StrategyFields() const {return FloatingRef<Fill_StrategyFields_Composite>(OptionalFieldsFill().cend());}
    FloatingRef<Fill_MiFIDFields_Composite> MiFIDFields() {return FloatingRef<Fill_MiFIDFields_Composite>(StrategyFields().end());}
    FloatingRef<Fill_MiFIDFields_Composite> MiFIDFields() const {return FloatingRef<Fill_MiFIDFields_Composite>(StrategyFields().cend());}
    ...
    FloatingRef<Fill_OptionalFieldsDerivatives_Composite> OptionalFieldsDerivatives() const {return FloatingRef<Fill_OptionalFieldsDerivatives_Composite>(MiFIDFields().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Fill);}
    size_t size() {return OptionalFieldsDerivatives().end()-begin();}
    size_t size() const {return OptionalFieldsDerivatives().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Fill*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Fill& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "tradeUniqueIdentifier=" << msg.tradeUniqueIdentifier << ";"
       << "OptionalFieldsFill=" << const_cast<Fill&>(msg).OptionalFieldsFill() << ";"
       << "StrategyFields=" << const_cast<Fill&>(msg).StrategyFields() << ";"
       << "MiFIDFields=" << const_cast<Fill&>(msg).MiFIDFields() << ";"
       << "OptionalFieldsDerivatives=" << const_cast<Fill&>(msg).OptionalFieldsDerivatives() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct Kill_MiFIDFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Kill_MiFIDFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Kill_MiFIDFields*>(p)->size();}
};
#pragma pack()
...
struct Kill_MiFIDFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Kill_MiFIDFields> data() {return BlockRef<Kill_MiFIDFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Kill_MiFIDFields> data() const {return BlockRef<Kill_MiFIDFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Kill_MiFIDFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Kill_MiFIDFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Kill_MiFIDFields_Composite& msg) {
    os << "Kill_MiFIDFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Kill : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    KillReason_enum killReason{KillReason_enum::Order_Cancelled_by_Client};
    AckQualifiers_set ackQualifiers;
    FloatingRef<Kill_MiFIDFields_Composite> MiFIDFields() {return FloatingRef<Kill_MiFIDFields_Composite>(begin() + fixed_size());}
    FloatingRef<Kill_MiFIDFields_Composite> MiFIDFields() const {return FloatingRef<Kill_MiFIDFields_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Kill);}
    size_t size() {return MiFIDFields().end()-begin();}
    size_t size() const {return MiFIDFields().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Kill*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Kill& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "ackQualifiers=" << msg.ackQualifiers << ";"
       << "MiFIDFields=" << const_cast<Kill&>(msg).MiFIDFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct CancelReplace_FreeTextSection {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_FreeTextSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_FreeTextSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_FreeTextSection& msg) {
    os << "CancelReplace_FreeTextSection{";
    os << "freeText=" << msg.freeText << ";"
       << "}";
    return os;
}
...
struct CancelReplace_FreeTextSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_FreeTextSection> data() {return BlockRef<CancelReplace_FreeTextSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_FreeTextSection> data() const {return BlockRef<CancelReplace_FreeTextSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_FreeTextSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_FreeTextSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_FreeTextSection_Composite& msg) {
    os << "CancelReplace_FreeTextSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace_OptionalFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_OptionalFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_OptionalFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_OptionalFields& msg) {
    os << "CancelReplace_OptionalFields{";
    os << "stopPx=" << msg.stopPx << ";"
       << "pegOffset=" << msg.pegOffset << ";"
       << "undisclosedPrice=" << msg.undisclosedPrice << ";"
       << "disclosedQty=" << msg.disclosedQty << ";"
...
struct CancelReplace_OptionalFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_OptionalFields> data() {return BlockRef<CancelReplace_OptionalFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_OptionalFields> data() const {return BlockRef<CancelReplace_OptionalFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_OptionalFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_OptionalFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_OptionalFields_Composite& msg) {
    os << "CancelReplace_OptionalFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace_ClearingFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_ClearingFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_ClearingFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_ClearingFields& msg) {
    os << "CancelReplace_ClearingFields{";
    os << "clearingFirmID=" << msg.clearingFirmID << ";"
       << "clientID=" << msg.clientID << ";"
       << "accountNumber=" << msg.accountNumber << ";"
       << "technicalOrigin=" << msg.technicalOrigin << ";"
...
struct CancelReplace_ClearingFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_ClearingFields> data() {return BlockRef<CancelReplace_ClearingFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_ClearingFields> data() const {return BlockRef<CancelReplace_ClearingFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_ClearingFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_ClearingFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_ClearingFields_Composite& msg) {
    os << "CancelReplace_ClearingFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_NotUsedGroup1& msg) {
    os << "CancelReplace_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct CancelReplace_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_NotUsedGroup1> data() {return BlockRef<CancelReplace_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_NotUsedGroup1> data() const {return BlockRef<CancelReplace_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_NotUsedGroup1_Composite& msg) {
    os << "CancelReplace_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace_NotUsedGroup2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_NotUsedGroup2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_NotUsedGroup2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_NotUsedGroup2& msg) {
    os << "CancelReplace_NotUsedGroup2{";
    os << "}";
    return os;
}
#pragma pack(1)
struct CancelReplace_NotUsedGroup2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_NotUsedGroup2> data() {return BlockRef<CancelReplace_NotUsedGroup2>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_NotUsedGroup2> data() const {return BlockRef<CancelReplace_NotUsedGroup2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_NotUsedGroup2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_NotUsedGroup2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_NotUsedGroup2_Composite& msg) {
    os << "CancelReplace_NotUsedGroup2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace_AdditionalInfos {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_AdditionalInfos);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_AdditionalInfos*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_AdditionalInfos& msg) {
    os << "CancelReplace_AdditionalInfos{";
    os << "longClientID=" << msg.longClientID << ";"
       << "}";
    return os;
}
...
struct CancelReplace_AdditionalInfos_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelReplace_AdditionalInfos> data() {return BlockRef<CancelReplace_AdditionalInfos>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelReplace_AdditionalInfos> data() const {return BlockRef<CancelReplace_AdditionalInfos>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace_AdditionalInfos_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace_AdditionalInfos_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace_AdditionalInfos_Composite& msg) {
    os << "CancelReplace_AdditionalInfos_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelReplace : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    CancelReplaceOrderSide_enum orderSide{CancelReplaceOrderSide_enum::Buy};
    OrderType_enum orderType{OrderType_enum::Market};
    TimeInForce_enum timeInForce{TimeInForce_enum::Day};
    AccountType_enum accountType{AccountType_enum::Client};
    LPRole_enum lPRole{LPRole_enum::Liquidity_Provider_or_Market_Maker};
    ...
    MiFIDIndicators_set miFIDIndicators;
    u16 sTPID;
    FloatingRef<CancelReplace_FreeTextSection_Composite> FreeTextSection() {return FloatingRef<CancelReplace_FreeTextSection_Composite>(begin() + fixed_size());}
    FloatingRef<CancelReplace_FreeTextSection_Composite> FreeTextSection() const {return FloatingRef<CancelReplace_FreeTextSection_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<CancelReplace_OptionalFields_Composite> OptionalFields() const {return FloatingRef<CancelReplace_OptionalFields_Composite>(FreeTextSection().cend());}
    ...
    FloatingRef<CancelReplace_ClearingFields_Composite> ClearingFields() const {return FloatingRef<CancelReplace_ClearingFields_Composite>(OptionalFields().cend());}
    ...
    FloatingRef<CancelReplace_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<CancelReplace_NotUsedGroup1_Composite>(ClearingFields().cend());}
    ...
    FloatingRef<CancelReplace_NotUsedGroup2_Composite> NotUsedGroup2() const {return FloatingRef<CancelReplace_NotUsedGroup2_Composite>(NotUsedGroup1().cend());}
    ...
    FloatingRef<CancelReplace_AdditionalInfos_Composite> AdditionalInfos() const {return FloatingRef<CancelReplace_AdditionalInfos_Composite>(NotUsedGroup2().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelReplace);}
    size_t size() {return AdditionalInfos().end()-begin();}
    size_t size() const {return AdditionalInfos().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelReplace*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelReplace& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "miFIDIndicators=" << msg.miFIDIndicators << ";"
       << "sTPID=" << msg.sTPID << ";"
       << "FreeTextSection=" << const_cast<CancelReplace&>(msg).FreeTextSection() << ";"
       << "OptionalFields=" << const_cast<CancelReplace&>(msg).OptionalFields() << ";"
       << "ClearingFields=" << const_cast<CancelReplace&>(msg).ClearingFields() << ";"
       << "NotUsedGroup1=" << const_cast<CancelReplace&>(msg).NotUsedGroup1() << ";"
       << "NotUsedGroup2=" << const_cast<CancelReplace&>(msg).NotUsedGroup2() << ";"
       << "AdditionalInfos=" << const_cast<CancelReplace&>(msg).AdditionalInfos() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct Reject_CollarFields {
    CollarRejectionType_enum collarRejType{CollarRejectionType_enum::Low_dynamic_collar};
    i64 breachedCollarPrice;
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Reject_CollarFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Reject_CollarFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Reject_CollarFields& msg) {
    os << "Reject_CollarFields{";
...
struct Reject_CollarFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Reject_CollarFields> data() {return BlockRef<Reject_CollarFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Reject_CollarFields> data() const {return BlockRef<Reject_CollarFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Reject_CollarFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Reject_CollarFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Reject_CollarFields_Composite& msg) {
    os << "Reject_CollarFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Reject_MiFIDFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Reject_MiFIDFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Reject_MiFIDFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Reject_MiFIDFields& msg) {
    os << "Reject_MiFIDFields{";
    os << "executionWithinFirmShortCode=" << msg.executionWithinFirmShortCode << ";"
       << "clientIdentificationShortCode=" << msg.clientIdentificationShortCode << ";"
       << "miFIDIndicators=" << msg.miFIDIndicators << ";"
       << "}";
...
struct Reject_MiFIDFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Reject_MiFIDFields> data() {return BlockRef<Reject_MiFIDFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<Reject_MiFIDFields> data() const {return BlockRef<Reject_MiFIDFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Reject_MiFIDFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Reject_MiFIDFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Reject_MiFIDFields_Composite& msg) {
    os << "Reject_MiFIDFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Reject : MessageHeader {
    ...
    AckQualifiers_set ackQualifiers;
    FloatingRef<Reject_CollarFields_Composite> CollarFields() {return FloatingRef<Reject_CollarFields_Composite>(begin() + fixed_size());}
    FloatingRef<Reject_CollarFields_Composite> CollarFields() const {return FloatingRef<Reject_CollarFields_Composite>(cbegin() + fixed_size());}
    FloatingRef<Reject_MiFIDFields_Composite> MiFIDFields() {return FloatingRef<Reject_MiFIDFields_Composite>(CollarFields().end());}
    FloatingRef<Reject_MiFIDFields_Composite> MiFIDFields() const {return FloatingRef<Reject_MiFIDFields_Composite>(CollarFields().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
...
inline std::ostream& operator<<(std::ostream& os, const Reject& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "ackQualifiers=" << msg.ackQualifiers << ";"
       << "CollarFields=" << const_cast<Reject&>(msg).CollarFields() << ";"
       << "MiFIDFields=" << const_cast<Reject&>(msg).MiFIDFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct Quotes_MiFIDShortcodes {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_MiFIDShortcodes);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_MiFIDShortcodes*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Quotes_MiFIDShortcodes& msg) {
    os << "Quotes_MiFIDShortcodes{";
    os << "investmentDecisionWFirmShortCode=" << msg.investmentDecisionWFirmShortCode << ";"
       << "nonExecutingBrokerShortCode=" << msg.nonExecutingBrokerShortCode << ";"
       << "clientIdentificationShortcode=" << msg.clientIdentificationShortcode << ";"
       << "}";
...
struct Quotes_MiFIDShortcodes_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Quotes_MiFIDShortcodes> data() {return BlockRef<Quotes_MiFIDShortcodes>(begin()+fixed_size(), numInGroup);}
    BlockRef<Quotes_MiFIDShortcodes> data() const {return BlockRef<Quotes_MiFIDShortcodes>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_MiFIDShortcodes_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_MiFIDShortcodes_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Quotes_MiFIDShortcodes_Composite& msg) {
    os << "Quotes_MiFIDShortcodes_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Quotes_ClearingDataset {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_ClearingDataset);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_ClearingDataset*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Quotes_ClearingDataset& msg) {
    os << "Quotes_ClearingDataset{";
    os << "clearingFirmID=" << msg.clearingFirmID << ";"
       << "clientID=" << msg.clientID << ";"
       << "accountNumber=" << msg.accountNumber << ";"
       << "technicalOrigin=" << msg.technicalOrigin << ";"
...
struct Quotes_ClearingDataset_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Quotes_ClearingDataset> data() {return BlockRef<Quotes_ClearingDataset>(begin()+fixed_size(), numInGroup);}
    BlockRef<Quotes_ClearingDataset> data() const {return BlockRef<Quotes_ClearingDataset>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_ClearingDataset_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_ClearingDataset_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Quotes_ClearingDataset_Composite& msg) {
    os << "Quotes_ClearingDataset_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Quotes_QuotesRep {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_QuotesRep);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_QuotesRep*>(p)->size();}
};
#pragma pack()
...
struct Quotes_QuotesRep_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<Quotes_QuotesRep> data() {return BlockRef<Quotes_QuotesRep>(begin()+fixed_size(), numInGroup);}
    BlockRef<Quotes_QuotesRep> data() const {return BlockRef<Quotes_QuotesRep>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes_QuotesRep_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Quotes_QuotesRep_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const Quotes_QuotesRep_Composite& msg) {
    os << "Quotes_QuotesRep_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct Quotes : MessageHeader {
    ...
    ExecutionInstruction_set executionInstruction;
    u16 sTPID;
    FloatingRef<Quotes_MiFIDShortcodes_Composite> MiFIDShortcodes() {return FloatingRef<Quotes_MiFIDShortcodes_Composite>(begin() + fixed_size());}
    FloatingRef<Quotes_MiFIDShortcodes_Composite> MiFIDShortcodes() const {return FloatingRef<Quotes_MiFIDShortcodes_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<Quotes_ClearingDataset_Composite> ClearingDataset() const {return FloatingRef<Quotes_ClearingDataset_Composite>(MiFIDShortcodes().cend());}
    FloatingRef<Quotes_QuotesRep_Composite> QuotesRep() {return FloatingRef<Quotes_QuotesRep_Composite>(ClearingDataset().end());}
    FloatingRef<Quotes_QuotesRep_Composite> QuotesRep() const {return FloatingRef<Quotes_QuotesRep_Composite>(ClearingDataset().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Quotes);}
    size_t size() {return QuotesRep().end()-begin();}
    size_t size() const {return QuotesRep().cend()-cbegin();}
...
inline std::ostream& operator<<(std::ostream& os, const Quotes& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "executionInstruction=" << msg.executionInstruction << ";"
       << "sTPID=" << msg.sTPID << ";"
       << "MiFIDShortcodes=" << const_cast<Quotes&>(msg).MiFIDShortcodes() << ";"
       << "ClearingDataset=" << const_cast<Quotes&>(msg).ClearingDataset() << ";"
       << "QuotesRep=" << const_cast<Quotes&>(msg).QuotesRep() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct QuoteAck_QuoteAcks {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    BuyRevisionIndicator_enum buyRevisionFlag{BuyRevisionIndicator_enum::New};
    SellRevisionIndicator_enum sellRevisionFlag{SellRevisionIndicator_enum::New};
    u16 bidErrorCode;
    u16 offerErrorCode;
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteAck_QuoteAcks);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteAck_QuoteAcks*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteAck_QuoteAcks& msg) {
    os << "QuoteAck_QuoteAcks{";
...
struct QuoteAck_QuoteAcks_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<QuoteAck_QuoteAcks> data() {return BlockRef<QuoteAck_QuoteAcks>(begin()+fixed_size(), numInGroup);}
    BlockRef<QuoteAck_QuoteAcks> data() const {return BlockRef<QuoteAck_QuoteAcks>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteAck_QuoteAcks_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteAck_QuoteAcks_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteAck_QuoteAcks_Composite& msg) {
    os << "QuoteAck_QuoteAcks_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct QuoteAck : MessageHeader {
    ...
    i32 executionWithinFirmShortCode;
    AckQualifiers_set ackQualifiers;
    FloatingRef<QuoteAck_QuoteAcks_Composite> QuoteAcks() {return FloatingRef<QuoteAck_QuoteAcks_Composite>(begin() + fixed_size());}
    FloatingRef<QuoteAck_QuoteAcks_Composite> QuoteAcks() const {return FloatingRef<QuoteAck_QuoteAcks_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteAck);}
    size_t size() {return QuoteAcks().end()-begin();}
    size_t size() const {return QuoteAcks().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteAck& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "executionWithinFirmShortCode=" << msg.executionWithinFirmShortCode << ";"
       << "ackQualifiers=" << msg.ackQualifiers << ";"
       << "QuoteAcks=" << const_cast<QuoteAck&>(msg).QuoteAcks() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct QuoteRequest_FreeTextSection {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteRequest_FreeTextSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteRequest_FreeTextSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteRequest_FreeTextSection& msg) {
    os << "QuoteRequest_FreeTextSection{";
    os << "freeText=" << msg.freeText << ";"
       << "}";
    return os;
}
...
struct QuoteRequest_FreeTextSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<QuoteRequest_FreeTextSection> data() {return BlockRef<QuoteRequest_FreeTextSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<QuoteRequest_FreeTextSection> data() const {return BlockRef<QuoteRequest_FreeTextSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteRequest_FreeTextSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteRequest_FreeTextSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteRequest_FreeTextSection_Composite& msg) {
    os << "QuoteRequest_FreeTextSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct QuoteRequest_RFQOptionalFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteRequest_RFQOptionalFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteRequest_RFQOptionalFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteRequest_RFQOptionalFields& msg) {
    os << "QuoteRequest_RFQOptionalFields{";
...
struct QuoteRequest_RFQOptionalFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<QuoteRequest_RFQOptionalFields> data() {return BlockRef<QuoteRequest_RFQOptionalFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<QuoteRequest_RFQOptionalFields> data() const {return BlockRef<QuoteRequest_RFQOptionalFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteRequest_RFQOptionalFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteRequest_RFQOptionalFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteRequest_RFQOptionalFields_Composite& msg) {
    os << "QuoteRequest_RFQOptionalFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct QuoteRequest : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    QuoteRequestOrderSide_enum orderSide{QuoteRequestOrderSide_enum::Buy};
    ...
    OpenClose_set openClose;
    ClearingInstruction_enum clearingInstruction{ClearingInstruction_enum::Process_normally__formerly_Systematic_posting_};
    RFQType_enum rFQType{RFQType_enum::Manual_RFQ};
    FloatingRef<QuoteRequest_FreeTextSection_Composite> FreeTextSection() {return FloatingRef<QuoteRequest_FreeTextSection_Composite>(begin() + fixed_size());}
    FloatingRef<QuoteRequest_FreeTextSection_Composite> FreeTextSection() const {return FloatingRef<QuoteRequest_FreeTextSection_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<QuoteRequest_RFQOptionalFields_Composite> RFQOptionalFields() const {return FloatingRef<QuoteRequest_RFQOptionalFields_Composite>(FreeTextSection().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(QuoteRequest);}
    size_t size() {return RFQOptionalFields().end()-begin();}
    size_t size() const {return RFQOptionalFields().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const QuoteRequest*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const QuoteRequest& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "clearingInstruction=" << msg.clearingInstruction << ";"
       << "rFQType=" << msg.rFQType << ";"
       << "FreeTextSection=" << const_cast<QuoteRequest&>(msg).FreeTextSection() << ";"
       << "RFQOptionalFields=" << const_cast<QuoteRequest&>(msg).RFQOptionalFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct CancelRequest_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelRequest_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelRequest_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelRequest_NotUsedGroup1& msg) {
    os << "CancelRequest_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct CancelRequest_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelRequest_NotUsedGroup1> data() {return BlockRef<CancelRequest_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelRequest_NotUsedGroup1> data() const {return BlockRef<CancelRequest_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelRequest_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelRequest_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelRequest_NotUsedGroup1_Composite& msg) {
    os << "CancelRequest_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelRequest_NotUsedGroup2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelRequest_NotUsedGroup2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelRequest_NotUsedGroup2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelRequest_NotUsedGroup2& msg) {
    os << "CancelRequest_NotUsedGroup2{";
    os << "}";
    return os;
}
#pragma pack(1)
struct CancelRequest_NotUsedGroup2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CancelRequest_NotUsedGroup2> data() {return BlockRef<CancelRequest_NotUsedGroup2>(begin()+fixed_size(), numInGroup);}
    BlockRef<CancelRequest_NotUsedGroup2> data() const {return BlockRef<CancelRequest_NotUsedGroup2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelRequest_NotUsedGroup2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelRequest_NotUsedGroup2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelRequest_NotUsedGroup2_Composite& msg) {
    os << "CancelRequest_NotUsedGroup2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CancelRequest : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    CancelRequestOrderSide_enum orderSide{CancelRequestOrderSide_enum::Buy};
    OrderType_enum orderType{OrderType_enum::Market};
    OrderCategory_enum orderCategory{OrderCategory_enum::Lit_Order};
    FloatingRef<CancelRequest_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<CancelRequest_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<CancelRequest_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<CancelRequest_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<CancelRequest_NotUsedGroup2_Composite> NotUsedGroup2() const {return FloatingRef<CancelRequest_NotUsedGroup2_Composite>(NotUsedGroup1().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CancelRequest);}
    size_t size() {return NotUsedGroup2().end()-begin();}
    size_t size() const {return NotUsedGroup2().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CancelRequest*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CancelRequest& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "NotUsedGroup1=" << const_cast<CancelRequest&>(msg).NotUsedGroup1() << ";"
       << "NotUsedGroup2=" << const_cast<CancelRequest&>(msg).NotUsedGroup2() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct MassCancel_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancel_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancel_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancel_NotUsedGroup1& msg) {
    os << "MassCancel_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct MassCancel_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<MassCancel_NotUsedGroup1> data() {return BlockRef<MassCancel_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<MassCancel_NotUsedGroup1> data() const {return BlockRef<MassCancel_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancel_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancel_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancel_NotUsedGroup1_Composite& msg) {
    os << "MassCancel_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct MassCancel_NotUsedGroup2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancel_NotUsedGroup2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancel_NotUsedGroup2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancel_NotUsedGroup2& msg) {
    os << "MassCancel_NotUsedGroup2{";
    os << "}";
    return os;
}
#pragma pack(1)
struct MassCancel_NotUsedGroup2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<MassCancel_NotUsedGroup2> data() {return BlockRef<MassCancel_NotUsedGroup2>(begin()+fixed_size(), numInGroup);}
    BlockRef<MassCancel_NotUsedGroup2> data() const {return BlockRef<MassCancel_NotUsedGroup2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancel_NotUsedGroup2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancel_NotUsedGroup2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancel_NotUsedGroup2_Composite& msg) {
    os << "MassCancel_NotUsedGroup2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct MassCancel : MessageHeader {
    ...
    MassCancelOrderSide_enum orderSide{MassCancelOrderSide_enum::Buy};
    u32 logicalAccessID;
    u16 oEPartitionID;
    u32 contractID;
    char8 maturity;
    AccountType_enum accountType{AccountType_enum::Client};
    OptionType_enum optionType{OptionType_enum::Call};
    OrderCategory_enum orderCategory{OrderCategory_enum::Lit_Order};
    i32 targetExecutionWithinFirmShortCode;
    FloatingRef<MassCancel_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<MassCancel_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<MassCancel_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<MassCancel_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<MassCancel_NotUsedGroup2_Composite> NotUsedGroup2() const {return FloatingRef<MassCancel_NotUsedGroup2_Composite>(NotUsedGroup1().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancel);}
    size_t size() {return NotUsedGroup2().end()-begin();}
    size_t size() const {return NotUsedGroup2().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancel*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancel& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "NotUsedGroup1=" << const_cast<MassCancel&>(msg).NotUsedGroup1() << ";"
       << "NotUsedGroup2=" << const_cast<MassCancel&>(msg).NotUsedGroup2() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct MassCancelAck_MiFIDFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancelAck_MiFIDFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancelAck_MiFIDFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancelAck_MiFIDFields& msg) {
    os << "MassCancelAck_MiFIDFields{";
    os << "executionWithinFirmShortCode=" << msg.executionWithinFirmShortCode << ";"
       << "clientIdentificationShortCode=" << msg.clientIdentificationShortCode << ";"
       << "miFIDIndicators=" << msg.miFIDIndicators << ";"
       << "}";
...
struct MassCancelAck_MiFIDFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<MassCancelAck_MiFIDFields> data() {return BlockRef<MassCancelAck_MiFIDFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<MassCancelAck_MiFIDFields> data() const {return BlockRef<MassCancelAck_MiFIDFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancelAck_MiFIDFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancelAck_MiFIDFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancelAck_MiFIDFields_Composite& msg) {
    os << "MassCancelAck_MiFIDFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct MassCancelAck : MessageHeader {
    ...
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    char2 instrumentGroupCode;
    MassCancelAckOrderSide_enum orderSide{MassCancelAckOrderSide_enum::Buy};
    u32 logicalAccessID;
    u16 oEPartitionID;
    u32 contractID;
    char8 maturity;
    ...
    AckQualifiers_set ackQualifiers;
    i32 targetExecutionWithinFirmShortCode;
    FloatingRef<MassCancelAck_MiFIDFields_Composite> MiFIDFields() {return FloatingRef<MassCancelAck_MiFIDFields_Composite>(begin() + fixed_size());}
    FloatingRef<MassCancelAck_MiFIDFields_Composite> MiFIDFields() const {return FloatingRef<MassCancelAck_MiFIDFields_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MassCancelAck);}
    size_t size() {return MiFIDFields().end()-begin();}
    size_t size() const {return MiFIDFields().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MassCancelAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MassCancelAck& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "ackQualifiers=" << msg.ackQualifiers << ";"
       << "targetExecutionWithinFirmShortCode=" << msg.targetExecutionWithinFirmShortCode << ";"
       << "MiFIDFields=" << const_cast<MassCancelAck&>(msg).MiFIDFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct OpenOrderRequest : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(OpenOrderRequest);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const OpenOrderRequest*>(p)->size();}
};
#pragma pack()
...
struct OwnershipRequestAck : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(OwnershipRequestAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const OwnershipRequestAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const OwnershipRequestAck& msg) {
    os << "OwnershipRequestAck{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "clientOrderID=" << msg.clientOrderID << ";"
...
struct OwnershipRequest : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(OwnershipRequest);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const OwnershipRequest*>(p)->size();}
};
#pragma pack()
...
struct TradeBustNotification : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(TradeBustNotification);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const TradeBustNotification*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const TradeBustNotification& msg) {
    os << "TradeBustNotification{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "bookIn=" << msg.bookIn << ";"
...
struct CollarBreachConfirmation : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CollarBreachConfirmation);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CollarBreachConfirmation*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CollarBreachConfirmation& msg) {
    os << "CollarBreachConfirmation{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct PriceInput : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    InputPriceType_enum inputPriceType{InputPriceType_enum::Valuation_Price};
    i64 price;
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(PriceInput);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const PriceInput*>(p)->size();}
};
#pragma pack()
...
struct LiquidityProviderCommand : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    LPActionCode_enum lPActionCode{LPActionCode_enum::Knock_In_By_Issuer_KIBI};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(LiquidityProviderCommand);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const LiquidityProviderCommand*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const LiquidityProviderCommand& msg) {
    os << "LiquidityProviderCommand{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct AskForQuote : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    AFQReason_enum aFQReason{AFQReason_enum::Quote_cancelled_by_the_Liquidity_Provider};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(AskForQuote);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const AskForQuote*>(p)->size();}
};
#pragma pack()
...
struct RFQNotification : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    RFQUpdateType_enum rFQUpdateType{RFQUpdateType_enum::New};
    RFQNotificationOrderSide_enum orderSide{RFQNotificationOrderSide_enum::Buy};
    char11 endClient;
    DarkExecutionInstruction_set darkExecutionInstruction;
    u64 minOrderQty;
    AccountType_enum accountType{AccountType_enum::Client};
...
struct RFQMatchingStatus : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    RFQMatchingStatusOrderSide_enum orderSide{RFQMatchingStatusOrderSide_enum::Buy};
    unsigned_char numberOfLPs;
    RecipientType_enum recipientType{RecipientType_enum::RFQ_Issuer};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RFQMatchingStatus);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RFQMatchingStatus*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RFQMatchingStatus& msg) {
    os << "RFQMatchingStatus{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "bookIn=" << msg.bookIn << ";"
...
struct RFQLPMatchingStatus : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RFQLPMatchingStatus);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RFQLPMatchingStatus*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RFQLPMatchingStatus& msg) {
    os << "RFQLPMatchingStatus{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "bookIn=" << msg.bookIn << ";"
...
struct UserNotification_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(UserNotification_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const UserNotification_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const UserNotification_NotUsedGroup1& msg) {
    os << "UserNotification_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct UserNotification_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<UserNotification_NotUsedGroup1> data() {return BlockRef<UserNotification_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<UserNotification_NotUsedGroup1> data() const {return BlockRef<UserNotification_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(UserNotification_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const UserNotification_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const UserNotification_NotUsedGroup1_Composite& msg) {
    os << "UserNotification_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct UserNotification : MessageHeader {
    ...
    char8 familyID;
    u32 symbolIndex;
    UserStatus_enum userStatus{UserStatus_enum::Trader_Algo_Suspended};
    u32 logicalAccessID;
    u64 orderSizeLimit;
    u64 orderAmountLimit;
    ExposureSide_enum exposureSide{ExposureSide_enum::Buy};
    MarketCondition_set marketCondition;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    char3 marketPlace;
    FloatingRef<UserNotification_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<UserNotification_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<UserNotification_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<UserNotification_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(UserNotification);}
    size_t size() {return NotUsedGroup1().end()-begin();}
    size_t size() const {return NotUsedGroup1().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const UserNotification*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const UserNotification& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "NotUsedGroup1=" << const_cast<UserNotification&>(msg).NotUsedGroup1() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct MMSignIn : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMSignIn);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMSignIn*>(p)->size();}
};
#pragma pack()
...
struct MMSignInAck : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMSignInAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMSignInAck*>(p)->size();}
};
#pragma pack()
...
struct InstrumentSynchronizationList_InstrumentSynchronizationSection {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(InstrumentSynchronizationList_InstrumentSynchronizationSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const InstrumentSynchronizationList_InstrumentSynchronizationSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const InstrumentSynchronizationList_InstrumentSynchronizationSection& msg) {
    os << "InstrumentSynchronizationList_InstrumentSynchronizationSection{";
...
struct InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<InstrumentSynchronizationList_InstrumentSynchronizationSection> data() {return BlockRef<InstrumentSynchronizationList_InstrumentSynchronizationSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<InstrumentSynchronizationList_InstrumentSynchronizationSection> data() const {return BlockRef<InstrumentSynchronizationList_InstrumentSynchronizationSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite& msg) {
    os << "InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct InstrumentSynchronizationList : MessageHeader {
    ...
    FloatingRef<InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite> InstrumentSynchronizationSection() {return FloatingRef<InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite>(begin() + fixed_size());}
    FloatingRef<InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite> InstrumentSynchronizationSection() const {return FloatingRef<InstrumentSynchronizationList_InstrumentSynchronizationSection_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(InstrumentSynchronizationList);}
    size_t size() {return InstrumentSynchronizationSection().end()-begin();}
    size_t size() const {return InstrumentSynchronizationSection().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const InstrumentSynchronizationList*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const InstrumentSynchronizationList& msg) {
    os << "InstrumentSynchronizationList{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "oEGOUTToMember=" << msg.oEGOUTToMember << ";"
       << "resynchronizationID=" << msg.resynchronizationID << ";"
       << "InstrumentSynchronizationSection=" << const_cast<InstrumentSynchronizationList&>(msg).InstrumentSynchronizationSection() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct SynchronizationTime : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SynchronizationTime);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SynchronizationTime*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const SynchronizationTime& msg) {
    os << "SynchronizationTime{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "oEGOUTToMember=" << msg.oEGOUTToMember << ";"
       << "resynchronizationID=" << msg.resynchronizationID << ";"
...
struct SecurityDefinitionRequest_StrategyLegs {
    u32 legSymbolIndex;
    u32 legRatio;
    LegSecurityType_enum legSecurityType{LegSecurityType_enum::Future};
    LegPutOrCall_enum legPutOrCall{LegPutOrCall_enum::Call};
    i64 legPrice;
    i64 legStrikePrice;
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SecurityDefinitionRequest_StrategyLegs);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SecurityDefinitionRequest_StrategyLegs*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const SecurityDefinitionRequest_StrategyLegs& msg) {
    os << "SecurityDefinitionRequest_StrategyLegs{";
...
struct SecurityDefinitionRequest_StrategyLegs_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<SecurityDefinitionRequest_StrategyLegs> data() {return BlockRef<SecurityDefinitionRequest_StrategyLegs>(begin()+fixed_size(), numInGroup);}
    BlockRef<SecurityDefinitionRequest_StrategyLegs> data() const {return BlockRef<SecurityDefinitionRequest_StrategyLegs>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SecurityDefinitionRequest_StrategyLegs_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SecurityDefinitionRequest_StrategyLegs_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const SecurityDefinitionRequest_StrategyLegs_Composite& msg) {
    os << "SecurityDefinitionRequest_StrategyLegs_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct SecurityDefinitionRequest : MessageHeader {
    ...
    StrategyCode_enum strategyCode{StrategyCode_enum::Jelly_Roll};
    FloatingRef<SecurityDefinitionRequest_StrategyLegs_Composite> StrategyLegs() {return FloatingRef<SecurityDefinitionRequest_StrategyLegs_Composite>(begin() + fixed_size());}
    FloatingRef<SecurityDefinitionRequest_StrategyLegs_Composite> StrategyLegs() const {return FloatingRef<SecurityDefinitionRequest_StrategyLegs_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SecurityDefinitionRequest);}
    size_t size() {return StrategyLegs().end()-begin();}
    size_t size() const {return StrategyLegs().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SecurityDefinitionRequest*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const SecurityDefinitionRequest& msg) {
    os << "SecurityDefinitionRequest{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
       ...
       << "StrategyLegs=" << const_cast<SecurityDefinitionRequest&>(msg).StrategyLegs() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct SecurityDefinitionAck : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SecurityDefinitionAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SecurityDefinitionAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const SecurityDefinitionAck& msg) {
    os << "SecurityDefinitionAck{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct MMProtectionRequest_MMPSection {
    ProtectionType_enum protectionType{ProtectionType_enum::Delta};
    u64 protectionThreshold;
    BreachAction_enum breachAction{BreachAction_enum::Ignore};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionRequest_MMPSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionRequest_MMPSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionRequest_MMPSection& msg) {
    os << "MMProtectionRequest_MMPSection{";
...
struct MMProtectionRequest_MMPSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<MMProtectionRequest_MMPSection> data() {return BlockRef<MMProtectionRequest_MMPSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<MMProtectionRequest_MMPSection> data() const {return BlockRef<MMProtectionRequest_MMPSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionRequest_MMPSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionRequest_MMPSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionRequest_MMPSection_Composite& msg) {
    os << "MMProtectionRequest_MMPSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct MMProtectionRequest : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    RequestType_enum requestType{RequestType_enum::Set};
    FloatingRef<MMProtectionRequest_MMPSection_Composite> MMPSection() {return FloatingRef<MMProtectionRequest_MMPSection_Composite>(begin() + fixed_size());}
    FloatingRef<MMProtectionRequest_MMPSection_Composite> MMPSection() const {return FloatingRef<MMProtectionRequest_MMPSection_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionRequest);}
    size_t size() {return MMPSection().end()-begin();}
    size_t size() const {return MMPSection().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionRequest*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionRequest& msg) {
    os << "MMProtectionRequest{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
       ...
       << "MMPSection=" << const_cast<MMProtectionRequest&>(msg).MMPSection() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct MMProtectionAck_MMPSection2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionAck_MMPSection2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionAck_MMPSection2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionAck_MMPSection2& msg) {
    os << "MMProtectionAck_MMPSection2{";
    os << "protectionType=" << msg.protectionType << ";"
       << "protectionThreshold=" << msg.protectionThreshold << ";"
       << "breachAction=" << msg.breachAction << ";"
...
struct MMProtectionAck_MMPSection2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<MMProtectionAck_MMPSection2> data() {return BlockRef<MMProtectionAck_MMPSection2>(begin()+fixed_size(), numInGroup);}
    BlockRef<MMProtectionAck_MMPSection2> data() const {return BlockRef<MMProtectionAck_MMPSection2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionAck_MMPSection2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionAck_MMPSection2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionAck_MMPSection2_Composite& msg) {
    os << "MMProtectionAck_MMPSection2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct MMProtectionAck : MessageHeader {
    ...
    FloatingRef<MMProtectionAck_MMPSection2_Composite> MMPSection2() {return FloatingRef<MMProtectionAck_MMPSection2_Composite>(begin() + fixed_size());}
    FloatingRef<MMProtectionAck_MMPSection2_Composite> MMPSection2() const {return FloatingRef<MMProtectionAck_MMPSection2_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MMProtectionAck);}
    size_t size() {return MMPSection2().end()-begin();}
    size_t size() const {return MMPSection2().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MMProtectionAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MMProtectionAck& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "MMPSection2=" << const_cast<MMProtectionAck&>(msg).MMPSection2() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct NewWholesaleOrder_WholesaleLegsRep {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewWholesaleOrder_WholesaleLegsRep);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewWholesaleOrder_WholesaleLegsRep*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewWholesaleOrder_WholesaleLegsRep& msg) {
    os << "NewWholesaleOrder_WholesaleLegsRep{";
    os << "legSymbolIndex=" << msg.legSymbolIndex << ";"
       << "legPrice=" << msg.legPrice << ";"
...
struct NewWholesaleOrder_WholesaleLegsRep_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewWholesaleOrder_WholesaleLegsRep> data() {return BlockRef<NewWholesaleOrder_WholesaleLegsRep>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewWholesaleOrder_WholesaleLegsRep> data() const {return BlockRef<NewWholesaleOrder_WholesaleLegsRep>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewWholesaleOrder_WholesaleLegsRep_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewWholesaleOrder_WholesaleLegsRep_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewWholesaleOrder_WholesaleLegsRep_Composite& msg) {
    os << "NewWholesaleOrder_WholesaleLegsRep_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewWholesaleOrder_WholesaleClientRep {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewWholesaleOrder_WholesaleClientRep);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewWholesaleOrder_WholesaleClientRep*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewWholesaleOrder_WholesaleClientRep& msg) {
    os << "NewWholesaleOrder_WholesaleClientRep{";
    os << "symbolIndex=" << msg.symbolIndex << ";"
       << "side=" << msg.side << ";"
       << "accountType=" << msg.accountType << ";"
       << "clearingFirmID=" << msg.clearingFirmID << ";"
...
struct NewWholesaleOrder_WholesaleClientRep_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<NewWholesaleOrder_WholesaleClientRep> data() {return BlockRef<NewWholesaleOrder_WholesaleClientRep>(begin()+fixed_size(), numInGroup);}
    BlockRef<NewWholesaleOrder_WholesaleClientRep> data() const {return BlockRef<NewWholesaleOrder_WholesaleClientRep>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewWholesaleOrder_WholesaleClientRep_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewWholesaleOrder_WholesaleClientRep_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewWholesaleOrder_WholesaleClientRep_Composite& msg) {
    os << "NewWholesaleOrder_WholesaleClientRep_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct NewWholesaleOrder : MessageHeader {
    ...
    i64 clientOrderID;
    u32 contractSymbolIndex;
    WholesaleTradeType_enum wholesaleTradeType{WholesaleTradeType_enum::Large_in_Scale_Trade_Formerly_Block_Trade};
    u32 lISTransactionID;
    StrategyCode_enum strategyCode{StrategyCode_enum::Jelly_Roll};
    i64 price;
    u64 quantity;
    i32 executionWithinFirmShortCode;
    MiFIDIndicators_set miFIDIndicators;
    WholesaleSide_enum wholesaleSide{WholesaleSide_enum::Buy};
    unsigned_char eSCBMembership;
    MessagePriceNotation_enum messagePriceNotation{MessagePriceNotation_enum::Price};
    FloatingRef<NewWholesaleOrder_WholesaleLegsRep_Composite> WholesaleLegsRep() {return FloatingRef<NewWholesaleOrder_WholesaleLegsRep_Composite>(begin() + fixed_size());}
    FloatingRef<NewWholesaleOrder_WholesaleLegsRep_Composite> WholesaleLegsRep() const {return FloatingRef<NewWholesaleOrder_WholesaleLegsRep_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<NewWholesaleOrder_WholesaleClientRep_Composite> WholesaleClientRep() const {return FloatingRef<NewWholesaleOrder_WholesaleClientRep_Composite>(WholesaleLegsRep().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(NewWholesaleOrder);}
    size_t size() {return WholesaleClientRep().end()-begin();}
    size_t size() const {return WholesaleClientRep().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const NewWholesaleOrder*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const NewWholesaleOrder& msg) {
    os << "NewWholesaleOrder{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
       ...
       << "eSCBMembership=" << msg.eSCBMembership << ";"
       << "messagePriceNotation=" << msg.messagePriceNotation << ";"
       << "WholesaleLegsRep=" << const_cast<NewWholesaleOrder&>(msg).WholesaleLegsRep() << ";"
       << "WholesaleClientRep=" << const_cast<NewWholesaleOrder&>(msg).WholesaleClientRep() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct WholesaleOrderAck_WholesaleAckLegsRep {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WholesaleOrderAck_WholesaleAckLegsRep);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WholesaleOrderAck_WholesaleAckLegsRep*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WholesaleOrderAck_WholesaleAckLegsRep& msg) {
    os << "WholesaleOrderAck_WholesaleAckLegsRep{";
    os << "legSymbolIndex=" << msg.legSymbolIndex << ";"
...
struct WholesaleOrderAck_WholesaleAckLegsRep_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<WholesaleOrderAck_WholesaleAckLegsRep> data() {return BlockRef<WholesaleOrderAck_WholesaleAckLegsRep>(begin()+fixed_size(), numInGroup);}
    BlockRef<WholesaleOrderAck_WholesaleAckLegsRep> data() const {return BlockRef<WholesaleOrderAck_WholesaleAckLegsRep>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WholesaleOrderAck_WholesaleAckLegsRep_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WholesaleOrderAck_WholesaleAckLegsRep_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WholesaleOrderAck_WholesaleAckLegsRep_Composite& msg) {
    os << "WholesaleOrderAck_WholesaleAckLegsRep_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct WholesaleOrderAck_WholesaleAckClearingRep {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WholesaleOrderAck_WholesaleAckClearingRep);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WholesaleOrderAck_WholesaleAckClearingRep*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WholesaleOrderAck_WholesaleAckClearingRep& msg) {
    os << "WholesaleOrderAck_WholesaleAckClearingRep{";
    os << "symbolIndex=" << msg.symbolIndex << ";"
       << "side=" << msg.side << ";"
       << "investmentDecisionWFirmShortCode=" << msg.investmentDecisionWFirmShortCode << ";"
       << "nonExecutingBrokerShortCode=" << msg.nonExecutingBrokerShortCode << ";"
...
struct WholesaleOrderAck_WholesaleAckClearingRep_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<WholesaleOrderAck_WholesaleAckClearingRep> data() {return BlockRef<WholesaleOrderAck_WholesaleAckClearingRep>(begin()+fixed_size(), numInGroup);}
    BlockRef<WholesaleOrderAck_WholesaleAckClearingRep> data() const {return BlockRef<WholesaleOrderAck_WholesaleAckClearingRep>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WholesaleOrderAck_WholesaleAckClearingRep_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WholesaleOrderAck_WholesaleAckClearingRep_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WholesaleOrderAck_WholesaleAckClearingRep_Composite& msg) {
    os << "WholesaleOrderAck_WholesaleAckClearingRep_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct WholesaleOrderAck : MessageHeader {
    ...
    WholesaleSide_enum wholesaleSide{WholesaleSide_enum::Buy};
    unsigned_char eSCBMembership;
    ResponseType_enum responseType{ResponseType_enum::Accept};
    u16 errorCode;
    AckQualifiers_set ackQualifiers;
    FloatingRef<WholesaleOrderAck_WholesaleAckLegsRep_Composite> WholesaleAckLegsRep() {return FloatingRef<WholesaleOrderAck_WholesaleAckLegsRep_Composite>(begin() + fixed_size());}
    FloatingRef<WholesaleOrderAck_WholesaleAckLegsRep_Composite> WholesaleAckLegsRep() const {return FloatingRef<WholesaleOrderAck_WholesaleAckLegsRep_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<WholesaleOrderAck_WholesaleAckClearingRep_Composite> WholesaleAckClearingRep() const {return FloatingRef<WholesaleOrderAck_WholesaleAckClearingRep_Composite>(WholesaleAckLegsRep().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WholesaleOrderAck);}
    size_t size() {return WholesaleAckClearingRep().end()-begin();}
    size_t size() const {return WholesaleAckClearingRep().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WholesaleOrderAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WholesaleOrderAck& msg) {
    os << "WholesaleOrderAck{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
       ...
       << "errorCode=" << msg.errorCode << ";"
       << "ackQualifiers=" << msg.ackQualifiers << ";"
       << "WholesaleAckLegsRep=" << const_cast<WholesaleOrderAck&>(msg).WholesaleAckLegsRep() << ";"
       << "WholesaleAckClearingRep=" << const_cast<WholesaleOrderAck&>(msg).WholesaleAckClearingRep() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct RequestForImpliedExecution : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RequestForImpliedExecution);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RequestForImpliedExecution*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RequestForImpliedExecution& msg) {
    os << "RequestForImpliedExecution{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct CrossOrder_FreeTextSection {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_FreeTextSection);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_FreeTextSection*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_FreeTextSection& msg) {
    os << "CrossOrder_FreeTextSection{";
    os << "freeText=" << msg.freeText << ";"
       << "}";
    return os;
}
...
struct CrossOrder_FreeTextSection_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CrossOrder_FreeTextSection> data() {return BlockRef<CrossOrder_FreeTextSection>(begin()+fixed_size(), numInGroup);}
    BlockRef<CrossOrder_FreeTextSection> data() const {return BlockRef<CrossOrder_FreeTextSection>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_FreeTextSection_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_FreeTextSection_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_FreeTextSection_Composite& msg) {
    os << "CrossOrder_FreeTextSection_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CrossOrder_MiFIDShortcodes {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_MiFIDShortcodes);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_MiFIDShortcodes*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_MiFIDShortcodes& msg) {
    os << "CrossOrder_MiFIDShortcodes{";
    os << "investmentDecisionWFirmShortCode=" << msg.investmentDecisionWFirmShortCode << ";"
       << "nonExecutingBrokerShortCode=" << msg.nonExecutingBrokerShortCode << ";"
       << "clientIdentificationShortcode=" << msg.clientIdentificationShortcode << ";"
       << "}";
...
struct CrossOrder_MiFIDShortcodes_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CrossOrder_MiFIDShortcodes> data() {return BlockRef<CrossOrder_MiFIDShortcodes>(begin()+fixed_size(), numInGroup);}
    BlockRef<CrossOrder_MiFIDShortcodes> data() const {return BlockRef<CrossOrder_MiFIDShortcodes>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_MiFIDShortcodes_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_MiFIDShortcodes_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_MiFIDShortcodes_Composite& msg) {
    os << "CrossOrder_MiFIDShortcodes_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CrossOrder_ClearingFieldsX {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_ClearingFieldsX);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_ClearingFieldsX*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_ClearingFieldsX& msg) {
    os << "CrossOrder_ClearingFieldsX{";
    os << "clearingFirmID=" << msg.clearingFirmID << ";"
       << "longClientID=" << msg.longClientID << ";"
       << "accountNumber=" << msg.accountNumber << ";"
       << "technicalOrigin=" << msg.technicalOrigin << ";"
...
struct CrossOrder_ClearingFieldsX_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CrossOrder_ClearingFieldsX> data() {return BlockRef<CrossOrder_ClearingFieldsX>(begin()+fixed_size(), numInGroup);}
    BlockRef<CrossOrder_ClearingFieldsX> data() const {return BlockRef<CrossOrder_ClearingFieldsX>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_ClearingFieldsX_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_ClearingFieldsX_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_ClearingFieldsX_Composite& msg) {
    os << "CrossOrder_ClearingFieldsX_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CrossOrder_StrategyFields {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_StrategyFields);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_StrategyFields*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_StrategyFields& msg) {
    os << "CrossOrder_StrategyFields{";
    os << "legLastPx=" << msg.legLastPx << ";"
       << "legLastQty=" << msg.legLastQty << ";"
       << "legInstrumentID=" << msg.legInstrumentID << ";"
       << "}";
...
struct CrossOrder_StrategyFields_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<CrossOrder_StrategyFields> data() {return BlockRef<CrossOrder_StrategyFields>(begin()+fixed_size(), numInGroup);}
    BlockRef<CrossOrder_StrategyFields> data() const {return BlockRef<CrossOrder_StrategyFields>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder_StrategyFields_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder_StrategyFields_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder_StrategyFields_Composite& msg) {
    os << "CrossOrder_StrategyFields_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct CrossOrder : MessageHeader {
    ...
    MiFIDIndicators_set miFIDIndicators;
    u16 nonExecutingClientID;
    OrderActorType_enum orderActorType{OrderActorType_enum::Initiator};
    MessagePriceNotation_enum messagePriceNotation{MessagePriceNotation_enum::Price};
    i64 orderTolerablePrice;
    FloatingRef<CrossOrder_FreeTextSection_Composite> FreeTextSection() {return FloatingRef<CrossOrder_FreeTextSection_Composite>(begin() + fixed_size());}
    FloatingRef<CrossOrder_FreeTextSection_Composite> FreeTextSection() const {return FloatingRef<CrossOrder_FreeTextSection_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<CrossOrder_MiFIDShortcodes_Composite> MiFIDShortcodes() const {return FloatingRef<CrossOrder_MiFIDShortcodes_Composite>(FreeTextSection().cend());}
    ...
    FloatingRef<CrossOrder_ClearingFieldsX_Composite> ClearingFieldsX() const {return FloatingRef<CrossOrder_ClearingFieldsX_Composite>(MiFIDShortcodes().cend());}
    ...
    FloatingRef<CrossOrder_StrategyFields_Composite> StrategyFields() const {return FloatingRef<CrossOrder_StrategyFields_Composite>(ClearingFieldsX().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(CrossOrder);}
    size_t size() {return StrategyFields().end()-begin();}
    size_t size() const {return StrategyFields().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const CrossOrder*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const CrossOrder& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "messagePriceNotation=" << msg.messagePriceNotation << ";"
       << "orderTolerablePrice=" << msg.orderTolerablePrice << ";"
       << "FreeTextSection=" << const_cast<CrossOrder&>(msg).FreeTextSection() << ";"
       << "MiFIDShortcodes=" << const_cast<CrossOrder&>(msg).MiFIDShortcodes() << ";"
       << "ClearingFieldsX=" << const_cast<CrossOrder&>(msg).ClearingFieldsX() << ";"
       << "StrategyFields=" << const_cast<CrossOrder&>(msg).StrategyFields() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct RFQAudit_RFQCounterparts {
    OrderOrigin_enum orderOrigin{OrderOrigin_enum::COB};
    i64 orderPrice;
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RFQAudit_RFQCounterparts);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RFQAudit_RFQCounterparts*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RFQAudit_RFQCounterparts& msg) {
    os << "RFQAudit_RFQCounterparts{";
...
struct RFQAudit_RFQCounterparts_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<RFQAudit_RFQCounterparts> data() {return BlockRef<RFQAudit_RFQCounterparts>(begin()+fixed_size(), numInGroup);}
    BlockRef<RFQAudit_RFQCounterparts> data() const {return BlockRef<RFQAudit_RFQCounterparts>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RFQAudit_RFQCounterparts_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RFQAudit_RFQCounterparts_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RFQAudit_RFQCounterparts_Composite& msg) {
    os << "RFQAudit_RFQCounterparts_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct RFQAudit : MessageHeader {
    ...
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    FloatingRef<RFQAudit_RFQCounterparts_Composite> RFQCounterparts() {return FloatingRef<RFQAudit_RFQCounterparts_Composite>(begin() + fixed_size());}
    FloatingRef<RFQAudit_RFQCounterparts_Composite> RFQCounterparts() const {return FloatingRef<RFQAudit_RFQCounterparts_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(RFQAudit);}
    size_t size() {return RFQCounterparts().end()-begin();}
    size_t size() const {return RFQCounterparts().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const RFQAudit*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const RFQAudit& msg) {
    ...
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       ...
       << "symbolIndex=" << msg.symbolIndex << ";"
       << "eMM=" << msg.eMM << ";"
       << "RFQCounterparts=" << const_cast<RFQAudit&>(msg).RFQCounterparts() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct WaveForLiquidity : MessageHeader {
    ...
    u64 sendingTime;
    i64 iOIID;
    WaveForLiquidityIOITransactionType_enum iOITransactionType{WaveForLiquidityIOITransactionType_enum::New};
    i64 originalIOIID;
    TargetCounterparties_set targetCounterparties;
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    IOISide_enum iOISide{IOISide_enum::Buy};
    u64 orderQuantity;
    IOIQuantity_enum iOIQuantity{IOIQuantity_enum::Small};
    IOIQualityIndication_enum iOIQualityIndication{IOIQualityIndication_enum::High};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WaveForLiquidity);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WaveForLiquidity*>(p)->size();}
};
#pragma pack()
...
struct WaveForLiquidityNotification : MessageHeader {
    ...
    i64 iOIID;
    i64 exchangeIOIID;
    IOIType_enum iOIType{IOIType_enum::Ack};
    i64 originalIOIID;
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    IOISide_enum iOISide{IOISide_enum::Buy};
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(WaveForLiquidityNotification);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const WaveForLiquidityNotification*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const WaveForLiquidityNotification& msg) {
    os << "WaveForLiquidityNotification{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct ClearBook : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(ClearBook);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const ClearBook*>(p)->size();}
};
#pragma pack()
...
struct Logon : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(Logon);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const Logon*>(p)->size();}
};
#pragma pack()
...
struct LogonAck : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(LogonAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const LogonAck*>(p)->size();}
};
#pragma pack()
...
struct LogonReject : MessageHeader {
    char8 exchangeID;
    LogonRejectCode_enum logonRejectCode{LogonRejectCode_enum::Unknown_Connection_Identifier};
    u32 lastClMsgSeqNum;
    u32 lastMsgSeqNum;
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(LogonReject);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const LogonReject*>(p)->size();}
};
#pragma pack()
...
struct Logout : MessageHeader {
    LogOutReasonCode_enum logOutReasonCode{LogOutReasonCode_enum::Regular_Logout};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
...
struct TestRequest : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(TestRequest);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const TestRequest*>(p)->size();}
};
#pragma pack()
...
struct TechnicalReject : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(TechnicalReject);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const TechnicalReject*>(p)->size();}
};
#pragma pack()
...
struct DeclarationEntry_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntry_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntry_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntry_NotUsedGroup1& msg) {
    os << "DeclarationEntry_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct DeclarationEntry_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<DeclarationEntry_NotUsedGroup1> data() {return BlockRef<DeclarationEntry_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<DeclarationEntry_NotUsedGroup1> data() const {return BlockRef<DeclarationEntry_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntry_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntry_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntry_NotUsedGroup1_Composite& msg) {
    os << "DeclarationEntry_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct DeclarationEntry : MessageHeader {
    ...
    u64 sendingTime;
    i64 clientOrderID;
    OperationType_enum operationType{OperationType_enum::Declaration_of_a_trade_outside_the_book};
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    ...
    GuaranteeFlag_enum guaranteeFlag{GuaranteeFlag_enum::Cleared_but_not_Guaranteed};
    MiFIDIndicators_set miFIDIndicators;
    TransactionPriceType_enum transactionPriceType{TransactionPriceType_enum::Plain_Vanilla_Trade};
    char8 principalCode;
    ...
    FloatingRef<DeclarationEntry_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<DeclarationEntry_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<DeclarationEntry_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<DeclarationEntry_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntry);}
    size_t size() {return NotUsedGroup1().end()-begin();}
    size_t size() const {return NotUsedGroup1().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntry*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntry& msg) {
    ...
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       ...
       << "NotUsedGroup1=" << const_cast<DeclarationEntry&>(msg).NotUsedGroup1() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct DeclarationEntryAck_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryAck_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryAck_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryAck_NotUsedGroup1& msg) {
    os << "DeclarationEntryAck_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct DeclarationEntryAck_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<DeclarationEntryAck_NotUsedGroup1> data() {return BlockRef<DeclarationEntryAck_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<DeclarationEntryAck_NotUsedGroup1> data() const {return BlockRef<DeclarationEntryAck_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryAck_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryAck_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryAck_NotUsedGroup1_Composite& msg) {
    os << "DeclarationEntryAck_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct DeclarationEntryAck : MessageHeader {
    ...
    char4 mICofSecondaryListing;
    OperationType_enum operationType{OperationType_enum::Declaration_of_a_trade_outside_the_book};
    PreMatchingType_enum preMatchingType{PreMatchingType_enum::Not_prematched};
    WaiverIndicator_set waiverIndicator;
    FloatingRef<DeclarationEntryAck_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<DeclarationEntryAck_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<DeclarationEntryAck_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<DeclarationEntryAck_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryAck);}
    size_t size() {return NotUsedGroup1().end()-begin();}
    size_t size() const {return NotUsedGroup1().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryAck& msg) {
    os << "DeclarationEntryAck{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       ...
       << "NotUsedGroup1=" << const_cast<DeclarationEntryAck&>(msg).NotUsedGroup1() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct DeclarationNotice_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationNotice_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationNotice_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationNotice_NotUsedGroup1& msg) {
    os << "DeclarationNotice_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct DeclarationNotice_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<DeclarationNotice_NotUsedGroup1> data() {return BlockRef<DeclarationNotice_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<DeclarationNotice_NotUsedGroup1> data() const {return BlockRef<DeclarationNotice_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationNotice_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationNotice_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationNotice_NotUsedGroup1_Composite& msg) {
    os << "DeclarationNotice_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct DeclarationNotice_NotUsedGroup2 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationNotice_NotUsedGroup2);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationNotice_NotUsedGroup2*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationNotice_NotUsedGroup2& msg) {
    os << "DeclarationNotice_NotUsedGroup2{";
    os << "}";
    return os;
}
#pragma pack(1)
struct DeclarationNotice_NotUsedGroup2_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<DeclarationNotice_NotUsedGroup2> data() {return BlockRef<DeclarationNotice_NotUsedGroup2>(begin()+fixed_size(), numInGroup);}
    BlockRef<DeclarationNotice_NotUsedGroup2> data() const {return BlockRef<DeclarationNotice_NotUsedGroup2>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationNotice_NotUsedGroup2_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationNotice_NotUsedGroup2_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationNotice_NotUsedGroup2_Composite& msg) {
    os << "DeclarationNotice_NotUsedGroup2_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct DeclarationNotice : MessageHeader {
    ...
    i64 clientOrderID;
    u64 declarationID;
    DeclarationStatus_enum declarationStatus{DeclarationStatus_enum::New_Waiting_for_Counterparty_Confirmation};
    OperationType_enum operationType{OperationType_enum::Declaration_of_a_trade_outside_the_book};
    u32 symbolIndex;
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    char8 enteringCounterparty;
    ...
    CCPID_enum cCPID{CCPID_enum::LCH_SA};
    char16 tradeUniqueIdentifier;
    FloatingRef<DeclarationNotice_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<DeclarationNotice_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<DeclarationNotice_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<DeclarationNotice_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    ...
    FloatingRef<DeclarationNotice_NotUsedGroup2_Composite> NotUsedGroup2() const {return FloatingRef<DeclarationNotice_NotUsedGroup2_Composite>(NotUsedGroup1().cend());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationNotice);}
    size_t size() {return NotUsedGroup2().end()-begin();}
    size_t size() const {return NotUsedGroup2().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationNotice*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationNotice& msg) {
    os << "DeclarationNotice{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "clientOrderID=" << msg.clientOrderID << ";"
       ...
       << "cCPID=" << msg.cCPID << ";"
       << "tradeUniqueIdentifier=" << msg.tradeUniqueIdentifier << ";"
       << "NotUsedGroup1=" << const_cast<DeclarationNotice&>(msg).NotUsedGroup1() << ";"
       << "NotUsedGroup2=" << const_cast<DeclarationNotice&>(msg).NotUsedGroup2() << ";"
       << "}";
    return os;
}
#pragma pack(1)
struct DeclarationCancelAndRefusal : MessageHeader {
    ...
    EMM_enum eMM{EMM_enum::Cash_and_Derivative_Central_Order_Book};
    u64 declarationID;
    ActionType_enum actionType{ActionType_enum::Declaration_Cancellation_Request};
    char16 tradeUniqueIdentifier;
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationCancelAndRefusal);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationCancelAndRefusal*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationCancelAndRefusal& msg) {
    os << "DeclarationCancelAndRefusal{";
    os << static_cast<const MessageHeader&>(msg);
    os << "clMsgSeqNum=" << msg.clMsgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "sendingTime=" << msg.sendingTime << ";"
...
struct FundPriceInput : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(FundPriceInput);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const FundPriceInput*>(p)->size();}
};
#pragma pack()
...
struct FundPriceInputAck : MessageHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(FundPriceInputAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const FundPriceInputAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const FundPriceInputAck& msg) {
    os << "FundPriceInputAck{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "clientOrderID=" << msg.clientOrderID << ";"
...
struct DeclarationEntryReject_NotUsedGroup1 {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryReject_NotUsedGroup1);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryReject_NotUsedGroup1*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryReject_NotUsedGroup1& msg) {
    os << "DeclarationEntryReject_NotUsedGroup1{";
    os << "}";
    return os;
}
#pragma pack(1)
struct DeclarationEntryReject_NotUsedGroup1_Composite {
    int8 blockLength;
    int8 numInGroup;
    BlockRef<DeclarationEntryReject_NotUsedGroup1> data() {return BlockRef<DeclarationEntryReject_NotUsedGroup1>(begin()+fixed_size(), numInGroup);}
    BlockRef<DeclarationEntryReject_NotUsedGroup1> data() const {return BlockRef<DeclarationEntryReject_NotUsedGroup1>(cbegin()+fixed_size(), numInGroup);}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryReject_NotUsedGroup1_Composite);}
    size_t size() {return data().end()-begin();}
    size_t size() const {return data().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryReject_NotUsedGroup1_Composite*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryReject_NotUsedGroup1_Composite& msg) {
    os << "DeclarationEntryReject_NotUsedGroup1_Composite{";
    os << "blockLength=" << msg.blockLength << ";"
       << "numInGroup=" << msg.numInGroup << ";"
...
struct DeclarationEntryReject : MessageHeader {
    ...
    unsigned_char rejectedMessage;
    u16 rejectedMessageID;
    FloatingRef<DeclarationEntryReject_NotUsedGroup1_Composite> NotUsedGroup1() {return FloatingRef<DeclarationEntryReject_NotUsedGroup1_Composite>(begin() + fixed_size());}
    FloatingRef<DeclarationEntryReject_NotUsedGroup1_Composite> NotUsedGroup1() const {return FloatingRef<DeclarationEntryReject_NotUsedGroup1_Composite>(cbegin() + fixed_size());}
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(DeclarationEntryReject);}
    size_t size() {return NotUsedGroup1().end()-begin();}
    size_t size() const {return NotUsedGroup1().cend()-cbegin();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const DeclarationEntryReject*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const DeclarationEntryReject& msg) {
    os << "DeclarationEntryReject{";
    os << static_cast<const MessageHeader&>(msg);
    os << "msgSeqNum=" << msg.msgSeqNum << ";"
       << "firmID=" << msg.firmID << ";"
       << "clientOrderID=" << msg.clientOrderID << ";"
       ...
       << "rejectedMessage=" << msg.rejectedMessage << ";"
       << "rejectedMessageID=" << msg.rejectedMessageID << ";"
       << "NotUsedGroup1=" << const_cast<DeclarationEntryReject&>(msg).NotUsedGroup1() << ";"
       << "}";
    return os;
}
