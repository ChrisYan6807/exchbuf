...
int64 = integer_type(LESignedLongField, -9223372036854775808, 9223372036854775806, 0)
...
class MessageHeader(Packet):
    ...
    LEShortEnumField("templateId", TemplateIdType.NewOrder, TemplateIdType),
    uint16("schemaId", 0),
    uint16("version", 365),
    ]
...
class StrategyCode_enum(bytes, Enum):
    Jelly_Roll = b'A'
    Butterfly = b'B'
    Call_or_Put_Cabinet = b'C'
    Spread = b'D'
    Calendar_Spread = b'E'
    Diagonal_Calendar_Spread = b'F'
    Guts = b'G'
    Two_by_One_Ratio_Spread = b'H'
    Iron_Butterfly = b'I'
    Combo = b'J'
    Strangle = b'K'
    Ladder = b'L'
    Strip = b'M'
    Straddle_Calendar_Spread = b'N'
    Pack = b'O'
    Diagonal_Straddle_Calendar_Spread = b'P'
    Simple_Inter_Commodity_Spread = b'Q'
    Conversion_Reversal = b'R'
    Straddle = b'S'
    Volatility_Trade = b'V'
    Condor = b'W'
    Box = b'X'
    Bundle = b'Y'
    Reduced_Tick_Spread = b'Z'
    Ladder_versus_Underlying = b'a'
    Butterfly_versus_Underlying = b'b'
    Call_Spread_versus_Put_versus_Underlying = b'c'
    Call_or_Put_Spread_versus_Underlying = b'd'
    Call_or_Put_Calendar_Spread_versus_Underlying = b'e'
    CallPut_Diagonal_Calendar_Spread_versus_Underlying = b'f'
    Guts_versus_Underlying = b'g'
    Two_by_One_Call_or_Put_Ratio_Spread_versus_Underlying = b'h'
    Iron_Butterfly_versus_Underlying = b'i'
    Combo_versus_Underlying = b'j'
    Strangle_versus_Underlying = b'k'
    Exchange_for_Physical = b'm'
    Straddle_Calendar_Spread_versus_Underlying = b'n'
    Put_Spread_versus_Call_versus_Underlying = b'p'
    Diagonal_Straddle_Calendar_Spread_versus_Underlying = b'q'
    Synthetic = b'r'
    Straddle_versus_Underlying = b's'
    Condor_versus_Underlying = b't'
    Buy_Write = b'u'
    Iron_Condor_versus_Underlying = b'v'
    Iron_Condor = b'w'
    Call_Spread_versus_Sell_a_Put = b'x'
    Put_Spread_versus_Sell_a_Call = b'y'
    Put_Straddle_versus_Sell_a_Call_or_a_Put = b'z'
    ICS_one_sided_combination_same_expiry = b'T'
    ICS_two_sided_combination_same_expiry = b'U'
    Ratio_Inter_Contract_Spread = b'l'
    Call_Spread_versus_Put_Or_Put_Spread_versus_Call = b'1'
    Ratio_Spread_Option = b'2'
...
class NewOrder_OptionalFields(Packet):
    ...
    ByteEnumField("undisclosedIcebergType", UndisclosedIcebergType_enum.Limit, UndisclosedIcebergType_enum),
    ByteEnumField("stopTriggeredTimeInForce", TriggeredStopTimeInForce_enum.Day, TriggeredStopTimeInForce_enum),
    ]
...
class NewOrder_ClearingFields(Packet):
    ...
    ByteEnumField("technicalOrigin", TechnicalOrigin_enum.Index_trading_arbitrage, TechnicalOrigin_enum),
    PacketField("openClose", 0, OpenClose_set),
    LEShortEnumField("clearingInstruction", ClearingInstruction_enum.Process_normally__formerly_Systematic_posting_, ClearingInstruction_enum),
    ByteEnumField("accountTypeCross", AccountTypeCross_enum.Client, AccountTypeCross_enum),
    ByteEnumField("tradingCapacityCross", TradingCapacityCross_enum.Dealing_on_own_account, TradingCapacityCross_enum),
    ]
...
class NewOrder(Packet):
    ...
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", OrderSide_enum.Buy, OrderSide_enum),
    ByteEnumField("orderType", OrderType_enum.Market, OrderType_enum),
    ByteEnumField("timeInForce", TimeInForce_enum.Day, TimeInForce_enum),
    i64("orderPx", -9223372036854775808),
    u64("orderQty", 18446744073709551615),
    i32("executionWithinFirmShortCode", -2147483648),
    ByteEnumField("tradingCapacity", TradingCapacity_enum.Dealing_on_own_account, TradingCapacity_enum),
    ByteEnumField("accountType", AccountType_enum.Client, AccountType_enum),
    ByteEnumField("lPRole", LPRole_enum.Liquidity_Provider_or_Market_Maker, LPRole_enum),
...
class Ack(Packet):
    ...
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", OrderSide_enum.Buy, OrderSide_enum),
    ByteEnumField("ackType", AckType_enum.New_Order_Ack, AckType_enum),
    ByteEnumField("ackPhase", AckPhase_enum.Continuous_Trading_Phase, AckPhase_enum),
...
class Fill_StrategyFields(Packet):
    ...
    ByteEnumField("legSide", LegSide_enum.Buy, LegSide_enum),
...
class Fill_OptionalFieldsDerivatives(Packet):
    ...
    ByteEnumField("messagePriceNotation", MessagePriceNotation_enum.Price, MessagePriceNotation_enum),
...
class Fill(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", FillOrderSide_enum.Buy, FillOrderSide_enum),
    ByteEnumField("tradeType", TradeType_enum.Conventional_Trade, TradeType_enum),
    ...
    u32("executionID", 4294967295),
    ByteEnumField("executionPhase", ExecutionPhase_enum.Continuous_Trading_Phase, ExecutionPhase_enum),
...
class Kill(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    LEShortEnumField("killReason", KillReason_enum.Order_Cancelled_by_Client, KillReason_enum),
    PacketField("ackQualifiers", 0, AckQualifiers_set),
...
class CancelReplace(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", CancelReplaceOrderSide_enum.Buy, CancelReplaceOrderSide_enum),
    ByteEnumField("orderType", OrderType_enum.Market, OrderType_enum),
    ByteEnumField("timeInForce", TimeInForce_enum.Day, TimeInForce_enum),
    ByteEnumField("accountType", AccountType_enum.Client, AccountType_enum),
    ByteEnumField("lPRole", LPRole_enum.Liquidity_Provider_or_Market_Maker, LPRole_enum),
...
class Reject_CollarFields(Packet):
    ...
    fields_desc = [
    ByteEnumField("collarRejType", CollarRejectionType_enum.Low_dynamic_collar, CollarRejectionType_enum),
...
class QuoteAck_QuoteAcks(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("buyRevisionFlag", BuyRevisionIndicator_enum.New, BuyRevisionIndicator_enum),
    ByteEnumField("sellRevisionFlag", SellRevisionIndicator_enum.New, SellRevisionIndicator_enum),
...
class QuoteRequest(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", QuoteRequestOrderSide_enum.Buy, QuoteRequestOrderSide_enum),
    ...
    PacketField("openClose", 0, OpenClose_set),
    LEShortEnumField("clearingInstruction", ClearingInstruction_enum.Process_normally__formerly_Systematic_posting_, ClearingInstruction_enum),
    ByteEnumField("rFQType", RFQType_enum.Manual_RFQ, RFQType_enum),
...
class CancelRequest(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", CancelRequestOrderSide_enum.Buy, CancelRequestOrderSide_enum),
    ByteEnumField("orderType", OrderType_enum.Market, OrderType_enum),
    ByteEnumField("orderCategory", OrderCategory_enum.Lit_Order, OrderCategory_enum),
...
class MassCancel(Packet):
    ...
    ByteEnumField("orderSide", MassCancelOrderSide_enum.Buy, MassCancelOrderSide_enum),
    u32("logicalAccessID", 4294967295),
    u16("oEPartitionID", 65535),
    u32("contractID", 4294967295),
    char8("maturity", ""),
    ByteEnumField("accountType", AccountType_enum.Client, AccountType_enum),
    ByteEnumField("optionType", OptionType_enum.Call, OptionType_enum),
    ByteEnumField("orderCategory", OrderCategory_enum.Lit_Order, OrderCategory_enum),
...
class MassCancelAck(Packet):
    ...
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    char2("instrumentGroupCode", ""),
    ByteEnumField("orderSide", MassCancelAckOrderSide_enum.Buy, MassCancelAckOrderSide_enum),
    u32("logicalAccessID", 4294967295),
    u16("oEPartitionID", 65535),
    u32("contractID", 4294967295),
    char8("maturity", ""),
...
class PriceInput(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("inputPriceType", InputPriceType_enum.Valuation_Price, InputPriceType_enum),
...
class LiquidityProviderCommand(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("lPActionCode", LPActionCode_enum.Knock_In_By_Issuer_KIBI, LPActionCode_enum),
    ]
...
class AskForQuote(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("aFQReason", AFQReason_enum.Quote_cancelled_by_the_Liquidity_Provider, AFQReason_enum),
    ]
...
class RFQNotification(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("rFQUpdateType", RFQUpdateType_enum.New, RFQUpdateType_enum),
    ByteEnumField("orderSide", RFQNotificationOrderSide_enum.Buy, RFQNotificationOrderSide_enum),
    char11("endClient", ""),
    PacketField("darkExecutionInstruction", 0, DarkExecutionInstruction_set),
    u64("minOrderQty", 18446744073709551615),
    ByteEnumField("accountType", AccountType_enum.Client, AccountType_enum),
...
class RFQMatchingStatus(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("orderSide", RFQMatchingStatusOrderSide_enum.Buy, RFQMatchingStatusOrderSide_enum),
    unsigned_char("numberOfLPs", 255),
    ByteEnumField("recipientType", RecipientType_enum.RFQ_Issuer, RecipientType_enum),
    ]
...
class UserNotification(Packet):
    ...
    char8("familyID", ""),
    u32("symbolIndex", 4294967295),
    ByteEnumField("userStatus", UserStatus_enum.Trader_Algo_Suspended, UserStatus_enum),
    u32("logicalAccessID", 4294967295),
    u64("orderSizeLimit", 18446744073709551615),
    u64("orderAmountLimit", 18446744073709551615),
    ByteEnumField("exposureSide", ExposureSide_enum.Buy, ExposureSide_enum),
...
class SecurityDefinitionRequest_StrategyLegs(Packet):
    ...
    ByteEnumField("legSecurityType", LegSecurityType_enum.Future, LegSecurityType_enum),
    ByteEnumField("legPutOrCall", LegPutOrCall_enum.Call, LegPutOrCall_enum),
...
class SecurityDefinitionRequest(Packet):
    ...
    CharEnumField("strategyCode", StrategyCode_enum.Jelly_Roll, StrategyCode_enum),
...
class MMProtectionRequest_MMPSection(Packet):
    ...
    fields_desc = [
    ByteEnumField("protectionType", ProtectionType_enum.Delta, ProtectionType_enum),
    u64("protectionThreshold", 18446744073709551615),
    ByteEnumField("breachAction", BreachAction_enum.Ignore, BreachAction_enum),
    ]
...
class MMProtectionRequest(Packet):
    ...
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("requestType", RequestType_enum.Set, RequestType_enum),
...
class NewWholesaleOrder_WholesaleClientRep(Packet):
    ...
    fields_desc = [
    u32("symbolIndex", 4294967295),
    ByteEnumField("side", Side_enum.Buy, Side_enum),
    ByteEnumField("accountType", AccountType_enum.Client, AccountType_enum),
    char8("clearingFirmID", ""),
    char16("longClientID", ""),
    char12("accountNumber", ""),
...
class NewWholesaleOrder(Packet):
    ...
    i64("clientOrderID", -9223372036854775808),
    u32("contractSymbolIndex", 4294967295),
    ByteEnumField("wholesaleTradeType", WholesaleTradeType_enum.Large_in_Scale_Trade_Formerly_Block_Trade, WholesaleTradeType_enum),
    u32("lISTransactionID", 4294967295),
    CharEnumField("strategyCode", StrategyCode_enum.Jelly_Roll, StrategyCode_enum),
    i64("price", -9223372036854775808),
    ...
    i32("executionWithinFirmShortCode", -2147483648),
    PacketField("miFIDIndicators", 0, MiFIDIndicators_set),
    ByteEnumField("wholesaleSide", WholesaleSide_enum.Buy, WholesaleSide_enum),
    unsigned_char("eSCBMembership", 255),
    ByteEnumField("messagePriceNotation", MessagePriceNotation_enum.Price, MessagePriceNotation_enum),
...
class WholesaleOrderAck(Packet):
    ...
    ByteEnumField("wholesaleSide", WholesaleSide_enum.Buy, WholesaleSide_enum),
    unsigned_char("eSCBMembership", 255),
    ByteEnumField("responseType", ResponseType_enum.Accept, ResponseType_enum),
    u16("errorCode", 65535),
    PacketField("ackQualifiers", 0, AckQualifiers_set),
...
class CrossOrder(Packet):
    ...
    PacketField("miFIDIndicators", 0, MiFIDIndicators_set),
    u16("nonExecutingClientID", 65535),
    ByteEnumField("orderActorType", OrderActorType_enum.Initiator, OrderActorType_enum),
    ByteEnumField("messagePriceNotation", MessagePriceNotation_enum.Price, MessagePriceNotation_enum),
    i64("orderTolerablePrice", -9223372036854775808),
...
class RFQAudit_RFQCounterparts(Packet):
    ...
    fields_desc = [
    ByteEnumField("orderOrigin", OrderOrigin_enum.COB, OrderOrigin_enum),
...
class WaveForLiquidity(Packet):
    ...
    u64("sendingTime", 18446744073709551615),
    i64("iOIID", -9223372036854775808),
    ByteEnumField("iOITransactionType", WaveForLiquidityIOITransactionType_enum.New, WaveForLiquidityIOITransactionType_enum),
    i64("originalIOIID", -9223372036854775808),
    PacketField("targetCounterparties", 0, TargetCounterparties_set),
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("iOISide", IOISide_enum.Buy, IOISide_enum),
    u64("orderQuantity", 18446744073709551615),
    ByteEnumField("iOIQuantity", IOIQuantity_enum.Small, IOIQuantity_enum),
    ByteEnumField("iOIQualityIndication", IOIQualityIndication_enum.High, IOIQualityIndication_enum),
    ]
...
class WaveForLiquidityNotification(Packet):
    ...
    ByteEnumField("iOIType", IOIType_enum.Ack, IOIType_enum),
    i64("originalIOIID", -9223372036854775808),
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ByteEnumField("iOISide", IOISide_enum.Buy, IOISide_enum),
...
class LogonReject(Packet):
    ...
    fields_desc = [
    char8("exchangeID", ""),
    ByteEnumField("logonRejectCode", LogonRejectCode_enum.Unknown_Connection_Identifier, LogonRejectCode_enum),
    u32("lastClMsgSeqNum", 4294967295),
    u32("lastMsgSeqNum", 4294967295),
    ]
...
class Logout(Packet):
    name = 'Logout'
    fields_desc = [
    ByteEnumField("logOutReasonCode", LogOutReasonCode_enum.Regular_Logout, LogOutReasonCode_enum),
    ]
...
class DeclarationEntry(Packet):
    ...
    u64("sendingTime", 18446744073709551615),
    i64("clientOrderID", -9223372036854775808),
    ByteEnumField("operationType", OperationType_enum.Declaration_of_a_trade_outside_the_book, OperationType_enum),
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    ...
    ByteEnumField("guaranteeFlag", GuaranteeFlag_enum.Cleared_but_not_Guaranteed, GuaranteeFlag_enum),
    PacketField("miFIDIndicators", 0, MiFIDIndicators_set),
    ByteEnumField("transactionPriceType", TransactionPriceType_enum.Plain_Vanilla_Trade, TransactionPriceType_enum),
    char8("principalCode", ""),
...
class DeclarationEntryAck(Packet):
    ...
    char4("mICofSecondaryListing", ""),
    ByteEnumField("operationType", OperationType_enum.Declaration_of_a_trade_outside_the_book, OperationType_enum),
    ByteEnumField("preMatchingType", PreMatchingType_enum.Not_prematched, PreMatchingType_enum),
...
class DeclarationNotice(Packet):
    ...
    i64("clientOrderID", -9223372036854775808),
    u64("declarationID", 18446744073709551615),
    ByteEnumField("declarationStatus", DeclarationStatus_enum.New_Waiting_for_Counterparty_Confirmation, DeclarationStatus_enum),
    ByteEnumField("operationType", OperationType_enum.Declaration_of_a_trade_outside_the_book, OperationType_enum),
    u32("symbolIndex", 4294967295),
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    char8("enteringCounterparty", ""),
    ...
    ByteEnumField("cCPID", CCPID_enum.LCH_SA, CCPID_enum),
    char16("tradeUniqueIdentifier", ""),
...
class DeclarationCancelAndRefusal(Packet):
    ...
    ByteEnumField("eMM", EMM_enum.Cash_and_Derivative_Central_Order_Book, EMM_enum),
    u64("declarationID", 18446744073709551615),
    ByteEnumField("actionType", ActionType_enum.Declaration_Cancellation_Request, ActionType_enum),
    char16("tradeUniqueIdentifier", ""),
    ]
