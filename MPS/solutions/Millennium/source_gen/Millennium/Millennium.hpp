...
using Int32 = BigEndian<int32_t, std::numeric_limits<int32_t>::min(), std::numeric_limits<int32_t>::max(), 0_i32>;
using Uint64 = BigEndian<uint64_t, std::numeric_limits<uint64_t>::min(), std::numeric_limits<uint64_t>::max(), 0_u64>;
...
struct MissedMsgRespType {
    ...
    constexpr bool operator==(const MissedMsgRespType& rhs) const {return value_ == rhs.value_;}
    constexpr bool operator!=(const MissedMsgRespType& rhs) const {return value_ != rhs.value_;}
    constexpr bool operator!=(Enum v) const {return value_ != v;}
    constexpr Enum value() const {return value_;}
...
struct MissedMsgRptType {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(3), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(3), });
    ...
    constexpr bool operator==(const MissedMsgRptType& rhs) const {return value_ == rhs.value_;}
    constexpr bool operator!=(const MissedMsgRptType& rhs) const {return value_ != rhs.value_;}
    constexpr bool operator!=(Enum v) const {return value_ != v;}
    constexpr Enum value() const {return value_;}
    constexpr uint8_t raw_value() const {return static_cast<uint8_t>(value_);}
...
struct AppID {
    ...
    static constexpr value_type min_value = std::min<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), });
    static constexpr value_type max_value = std::max<value_type>({static_cast<uint8_t>(0), static_cast<uint8_t>(1), static_cast<uint8_t>(2), static_cast<uint8_t>(3), static_cast<uint8_t>(4), });
    constexpr AppID():value_{max_value} {}
    constexpr explicit AppID(uint8_t v):value_{v} {}
    constexpr AppID(Enum v):value_{v} {}
    constexpr bool operator==(const AppID& rhs) const {return value_ == rhs.value_;}
    constexpr bool operator!=(const AppID& rhs) const {return value_ != rhs.value_;}
    constexpr bool operator!=(Enum v) const {return value_ != v;}
    constexpr Enum value() const {return value_;}
    constexpr uint8_t raw_value() const {return static_cast<uint8_t>(value_);}
...
struct AppStatus {
    ...
    constexpr bool operator==(const AppStatus& rhs) const {return value_ == rhs.value_;}
    constexpr bool operator!=(const AppStatus& rhs) const {return value_ != rhs.value_;}
    constexpr bool operator!=(Enum v) const {return value_ != v;}
    constexpr Enum value() const {return value_;}
    constexpr uint8_t raw_value() const {return static_cast<uint8_t>(value_);}
...
struct MsgHeader {
    ...
    static constexpr size_t fixed_size() noexcept {return sizeof(MsgHeader);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MsgHeader*>(p)->size();}
};
#pragma pack()
...
struct MissedMessageRequest : MsgHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MissedMessageRequest);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MissedMessageRequest*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MissedMessageRequest& msg) {
    os << "MissedMessageRequest{";
    os << static_cast<const MsgHeader&>(msg);
    os << "appID=" << msg.appID << ";"
...
struct MissedMessageRequestAck : MsgHeader {
    MissedMsgRespType responseType{MissedMsgRespType::SUCESSFUL};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(MissedMessageRequestAck);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const MissedMessageRequestAck*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const MissedMessageRequestAck& msg) {
    os << "MissedMessageRequestAck{";
    os << static_cast<const MsgHeader&>(msg);
...
struct TransmissionComplete : MsgHeader {
    MissedMsgRptType responseType{MissedMsgRptType::DOWNLOAD_COMPLETE};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(TransmissionComplete);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const TransmissionComplete*>(p)->size();}
};
#pragma pack()
inline std::ostream& operator<<(std::ostream& os, const TransmissionComplete& msg) {
    os << "TransmissionComplete{";
    os << static_cast<const MsgHeader&>(msg);
    os << "responseType=" << msg.responseType << ";"
       << "}";
    return os;
...
struct SystemStatus : MsgHeader {
    ...
    AppStatus appStatus{AppStatus::RECOVERY_SERVICE_RESUMED};
    char* begin() {return reinterpret_cast<char*>(this);}
    const char* cbegin() const {return reinterpret_cast<const char*>(this);}
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(SystemStatus);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const SystemStatus*>(p)->size();}
};
#pragma pack()
...
struct BusinessReject : MsgHeader {
    ...
    char* end() {return begin()+size();}
    const char* cend() const {return cbegin()+size();}
    static constexpr size_t fixed_size() noexcept {return sizeof(BusinessReject);}
    size_t size() {return fixed_size();}
    size_t size() const {return fixed_size();}
    static size_t wire_size(const char* p) {return reinterpret_cast<const BusinessReject*>(p)->size();}
};
#pragma pack()
