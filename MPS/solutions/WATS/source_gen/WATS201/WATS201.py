...
class Header(Packet):
    ...
    fields_desc = [
    u16("length", 0),
    LEShortEnumField("msgType", MsgType.Test, MsgType),
    u32("seqNum", 0),
    u64("timestamp", 0),
...
class MifidField(Packet):
    ...
    fields_desc = [
    u32("shortCode", 0),
    ByteEnumField("qualifier", PartyRoleQualifier.NA, PartyRoleQualifier),
    ]
...
class ConnectionClose(Packet):
    ...
    fields_desc = [
    ByteEnumField("reason", ConnectionCloseReason.ProtocolError, ConnectionCloseReason),
    ]
...
class LoginResponse(Packet):
    name = 'LoginResponse'
    fields_desc = [
    ByteEnumField("result", LoginResult.Ok, LoginResult),
    u32("nextExpectedSeqNum", 0),
...
class OrderAdd(Packet):
    ...
    ByteEnumField("side", OrderSide.Buy, OrderSide),
    Price("price", 0),
    Price("triggerPrice", 0),
    u64("quantity", 0),
    u64("displayQty", 0),
    ByteEnumField("capacity", Capacity.Agency, Capacity),
    Account("account", ""),
    ByteEnumField("accountType", AccountType.Missing, AccountType),
    ByteEnumField("flags", OrderFlags.NONE, OrderFlags),
    PacketField("mifidFields", "", MifidFields),
    u64("expire", 0),
    Memo("memo", ""),
    ClientOrderId("clientOrderId", ""),
    ClearingCode("clearingMemberCode", ""),
    ByteEnumField("clearingMemberClearingIdentifier", ClearingIdentifier.NotApplicable, ClearingIdentifier),
    ByteEnumField("execInst", ExecInst.NONE, ExecInst),
    u8("feeStructureId", 0),
...
class OrderAddResponse(Packet):
    ...
    u64("displayQty", 0),
    u64("filled", 0),
    ByteEnumField("status", OrderStatus.New, OrderStatus),
    LEShortEnumField("reason", OrderRejectionReason.NA, OrderRejectionReason),
    ByteEnumField("execTypeReason", ExecTypeReason.NA, ExecTypeReason),
    ClientOrderId("clientOrderId", ""),
    ]
...
class OrderModifyResponse(Packet):
    ...
    u64("filled", 0),
    ByteEnumField("status", OrderStatus.New, OrderStatus),
    ByteEnumField("priorityFlag", PriorityFlag.Lost, PriorityFlag),
    LEShortEnumField("reason", OrderRejectionReason.NA, OrderRejectionReason),
    ClientOrderId("clientOrderId", ""),
    ]
...
class OrderMassCancel(Packet):
    ...
    fields_desc = [
    ByteEnumField("massCancelRequestType", MassCancelRequestType.CancelForSecurity, MassCancelRequestType),
    ByteEnumField("targetPartyRole", TargetPartyRole.NONE, TargetPartyRole),
    u32("targetPartyId", 0),
...
class OrderMassCancelResponse(Packet):
    ...
    u32("targetPartyId", 0),
    u32("marketSegmentId", 0),
    LEShortEnumField("reason", MassCancelRejectionReason.Other, MassCancelRejectionReason),
    ClientOrderId("clientOrderId", ""),
    ]
...
class OrderExecute(Packet):
    ...
    u64("quantity", 0),
    u64("leavesQty", 0),
    ByteEnumField("liquidityIndicator", LiquidityIndicator.BuyOrderExecution, LiquidityIndicator),
    LEShortEnumField("currency", Currency.ALL, Currency),
    ByteEnumField("side", OrderSide.Buy, OrderSide),
    ClientOrderId("clientOrderId", ""),
    ]
...
class Reject(Packet):
    ...
    fields_desc = [
    u32("refSeqNum", 0),
    ByteEnumField("rejectReason", RejectReason.NA, RejectReason),
    ]
...
class TcrParty(Packet):
    ...
    Account("account", ""),
    ByteEnumField("accountType", AccountType.Missing, AccountType),
    ByteEnumField("orderCapacity", Capacity.Agency, Capacity),
    u8("feeStructureId", 0),
    InterestedParty("interestedParty", ""),
    Memo("memo", ""),
    ]
...
class TradeCaptureReportSingle(Packet):
    ...
    u32("tradeId", 0),
    ByteEnumField("tradeReportTransType", TradeReportTransType.New, TradeReportTransType),
    ByteEnumField("tradeReportType", TradeReportType.Submit, TradeReportType),
    ByteEnumField("tradeType", TradeType.PrivatelyNegotiatedTrade, TradeType),
    ByteEnumField("algorithmicTradeIndicator", AlgorithmicTradeIndicator.NA, AlgorithmicTradeIndicator),
    ByteEnumField("execType", ExecType.NA, ExecType),
...
class TradeCaptureReportResponse(Packet):
    ...
    TradeReportId("tradeReportId", ""),
    u64("secondaryTradeReportId", 0),
    ByteEnumField("status", TcrStatus.New, TcrStatus),
    LEShortEnumField("reason", TcrRejectionReason.NA, TcrRejectionReason),
    ]
...
class TestEvent(Packet):
    ...
    ByteEnumField("eventType", EventType.Flush, EventType),
    ]
...
class MassQuoteResponse(Packet):
    ...
    ByteEnumField("status", MassQuoteStatus.Accepted, MassQuoteStatus),
    LEShortEnumField("reason", MassQuoteRejectionReason.NA, MassQuoteRejectionReason),
    u8("feeStructureId", 0),
    ]
...
class MarketMakerCommand(Packet):
    ...
    fields_desc = [
    u32("instrumentId", 0),
    ByteEnumField("action", CommandAction.ChangeToHybridBuyOnly, CommandAction),
    ]
...
class MarketMakerCommandResponse(Packet):
    ...
    fields_desc = [
    u32("refId", 0),
    ByteEnumField("result", CommandResult.Success, CommandResult),
    LEShortEnumField("rejectionCode", CommandRejectionCode.Other, CommandRejectionCode),
    ]
...
class RequestForExecution(Packet):
    ...
    fields_desc = [
    u32("instrumentId", 0),
    ByteEnumField("reason", RequestForExecutionReason.PassiveQuote, RequestForExecutionReason),
    ]
...
class BidOfferUpdate(Packet):
    ...
    fields_desc = [
    u32("instrumentId", 0),
    ByteEnumField("updateType", BidOfferUpdateType.Ipo, BidOfferUpdateType),
    u64("totalBidSize", 0),
...
class TradingSessionStatus(Packet):
    ...
    MicCode("marketId", ""),
    u32("date", 0),
    ByteEnumField("tradingSessionEvent", TradingSessionEvent.PreviousDayRestateStart, TradingSessionEvent),
    ]
