...
edci_DerivativesAppVersionID = "15.0"
...
class MessageHeaderInComp(Packet):
    ...
    LEShortEnumField("templateID", TemplateID.CrossRequestNotification, TemplateID),
    Pad2("pad2", ""),
    ]
...
class CrossRequestNotification(Packet):
    name = 'CrossRequestNotification'
    fields_desc = [
...
class EnterClipRequestNotification(Packet):
    name = 'EnterClipRequestNotification'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("rBCHeader", "", RBCHeaderComp),
    SecurityID("securityID", 0x8000000000000000),
