...
eti_DerivativesAppVersionID = "15.0"
...
MaxBoundaryPrice = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
MinBoundaryPrice = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
NoRiskLimitTypes = integer_type(ByteField, 0, 6, 0xFF)
...
TradingReferencePrice = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
class RiskLimitQtyGrpComp(Packet):
    ...
    ByteEnumField("riskLimitType", RiskLimitType.Gross_limit, RiskLimitType),
    Pad7("pad7", ""),
    ]
...
class TESInquireBoundaryPricesRequest(Packet):
    name = 'TESInquireBoundaryPricesRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    SecurityID("securityID", 0x8000000000000000),
...
class TESInquireBoundaryPricesResponse(Packet):
    name = 'TESInquireBoundaryPricesResponse'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("responseHeader", "", ResponseHeaderComp),
    MinBoundaryPrice("minBoundaryPrice", 0x8000000000000000),
    MaxBoundaryPrice("maxBoundaryPrice", 0x8000000000000000),
    MarketSegmentID("marketSegmentID", 0x80000000),
    Pad4("pad4", ""),
    ]
...
class UpdateReferencePriceRequest(Packet):
    name = 'UpdateReferencePriceRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    SecurityID("securityID", 0x8000000000000000),
    TradingReferencePrice("tradingReferencePrice", 0x8000000000000000),
    MarketSegmentID("marketSegmentID", 0x80000000),
    Pad4("pad4", ""),
    ]

class UpdateReferencePricesResponse(Packet):
    name = 'UpdateReferencePricesResponse'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("responseHeader", "", ResponseHeaderComp),
    ]
