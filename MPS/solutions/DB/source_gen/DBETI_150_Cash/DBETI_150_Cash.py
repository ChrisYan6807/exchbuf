...
AggregatedGrossAmount = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
AggregatedNetAmount = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
AutoExecLimitPrice = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
DayOrderEntriesCount = integer_type(LELongField, 0, 18446744073709551614, 0xFFFFFFFFFFFFFFFF)
DayOrderExecutionsCount = integer_type(LELongField, 0, 18446744073709551614, 0xFFFFFFFFFFFFFFFF)
DayTradingSecuritiesCount = integer_type(LELongField, 0, 18446744073709551614, 0xFFFFFFFFFFFFFFFF)
...
DisplayHighQty = float_decimal(8, 4, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
SideGrossTradeAmt = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
TransactionCostAmt = float_decimal(8, 8, True, True, -9223372036854775807, 2**63-1, 0x8000000000000000)
...
class MessageHeaderInComp(Packet):
    ...
    LEShortEnumField("templateID", TemplateID.ApproveTESTradeRequest, TemplateID),
...
class RiskLimitTypesGrpComp(Packet):
    name = 'RiskLimitTypesGrpComp'
    fields_desc = [
    RiskLimitAmount("riskLimitAmount", 0x8000000000000000),
    ByteEnumField("riskLimitType", RiskLimitType.Gross_limit, RiskLimitType),
    ByteEnumField("riskLimitLevel", RiskLimitLevel.Level_1, RiskLimitLevel),
    Pad6("pad6", ""),
    ]
...
class SRQSQuoteEntryGrpComp(Packet):
    ...
    ByteEnumField("quotingFrequency", QuotingFrequency.HF, QuotingFrequency),
...
class SecurityStatusEventGrpComp(Packet):
    ...
    ByteEnumField("eventType", EventType.Redemption, EventType),
    Pad3("pad3", ""),
    ]
...
class ApproveTESTradeRequest(Packet):
    ...
    LEShortEnumField("trdType", TrdType.OTC, TrdType),
    ByteEnumField("tradingCapacity", TradingCapacity.Customer, TradingCapacity),
    ...
    ByteEnumField("valueCheckTypeQuantity", ValueCheckTypeQuantity.Do_not_check, ValueCheckTypeQuantity),
...
class DeleteOrderBroadcast(Packet):
    ...
    PartyIDEnteringTrader("partyIDEnteringTrader", 0xFFFFFFFF),
    PartyIDSessionID("partyIDSessionID", 0xFFFFFFFF),
    LEShortEnumField("execRestatementReason", ExecRestatementReason.Corporate_Action, ExecRestatementReason),
    ByteEnumField("partyIDEnteringFirm", PartyIDEnteringFirm.Participant, PartyIDEnteringFirm),
...
class InquireOverallRiskLimitsRequest(Packet):
    name = 'InquireOverallRiskLimitsRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    PartyIDSponsoredAccessUnit("partyIDSponsoredAccessUnit", 0xFFFFFFFF),
...
class IssuerNotification(Packet):
    ...
    MarketSegmentID("marketSegmentID", 0x80000000),
    PartyIDSessionID("partyIDSessionID", 0xFFFFFFFF),
    ByteEnumField("securityTradingStatus", SecurityTradingStatus.Market_Imbalance_Buy, SecurityTradingStatus),
    ByteEnumField("eventType", EventType.Redemption, EventType),
    Pad6("pad6", ""),
    ]
...
class IssuerSecurityStateChangeRequest(Packet):
    ...
    ByteEnumField("securityStatus", SecurityStatus.Knocked_out, SecurityStatus),
    ByteEnumField("soldOutIndicator", SoldOutIndicator.Revert_sold_out, SoldOutIndicator),
    Pad1("pad1", ""),
...
class ModifyOrderRequest(Packet):
    ...
    TargetPartyIDSessionID("targetPartyIDSessionID", 0xFFFFFFFF),
    ByteEnumField("tradingSessionSubID", TradingSessionSubID.Opening_auction, TradingSessionSubID),
    ByteEnumField("stopPxIndicator", StopPxIndicator.Do_not_overwrite, StopPxIndicator),
...
class OTCUploadBroadcast(Packet):
    ...
    ByteEnumField("transactionCostCode", TransactionCostCode.No_additional_cost, TransactionCostCode),
...
class OverallRiskLimitsDefinitionRequest(Packet):
    name = 'OverallRiskLimitsDefinitionRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    PartyIDSponsoredAccessUnit("partyIDSponsoredAccessUnit", 0xFFFFFFFF),
    Pad4("pad4", ""),
    ThrottleTimeInterval("throttleTimeInterval", 0x8000000000000000),
    FieldLenField("noRiskLimitTypes", 0, fmt="<B", count_of="riskLimitTypesGrp"),
    Pad7("pad7", ""),
        PacketListField("riskLimitTypesGrp", None, RiskLimitTypesGrpComp, count_from=lambda pkt:pkt.noRiskLimitTypes),
    ]

class OverallRiskLimitsDefinitionResponse(Packet):
    name = 'OverallRiskLimitsDefinitionResponse'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("responseHeader", "", ResponseHeaderComp),
...
class OverallRiskLimitsReport(Packet):
    name = 'OverallRiskLimitsReport'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("responseHeader", "", ResponseHeaderComp),
    RiskLimitReportID("riskLimitReportID", 0xFFFFFFFFFFFFFFFF),
    ThrottleTimeInterval("throttleTimeInterval", 0x8000000000000000),
    AggregatedGrossAmount("aggregatedGrossAmount", 0x8000000000000000),
    AggregatedNetAmount("aggregatedNetAmount", 0x8000000000000000),
    PartyIDSponsoredAccessUnit("partyIDSponsoredAccessUnit", 0xFFFFFFFF),
    FieldLenField("noRiskLimitTypes", 0, fmt="<B", count_of="riskLimitTypesGrp"),
    Pad3("pad3", ""),
        PacketListField("riskLimitTypesGrp", None, RiskLimitTypesGrpComp, count_from=lambda pkt:pkt.noRiskLimitTypes),
...
class RFQRejectNotification(Packet):
    ...
    QuoteID("quoteID", 0xFFFFFFFFFFFFFFFF),
    MarketSegmentID("marketSegmentID", 0x80000000),
    ByteEnumField("quoteRequestRejectReason", QuoteRequestRejectReason.Exchange_closed, QuoteRequestRejectReason),
    PartyExecutingFirm("partyExecutingFirm", ""),
    Pad6("pad6", ""),
    ]

class RFQRejectRequest(Packet):
    name = 'RFQRejectRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    SecurityID("securityID", 0x8000000000000000),
...
class RFQReplyNotification(Packet):
    name = 'RFQReplyNotification'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("rBCHeaderME", "", RBCHeaderMEComp),
    SecurityID("securityID", 0x8000000000000000),
...
class RFQReplyRequest(Packet):
    name = 'RFQReplyRequest'
    fields_desc = [
    PacketField("messageHeaderIn", "", MessageHeaderInComp),
    PacketField("requestHeader", "", RequestHeaderComp),
    SecurityID("securityID", 0x8000000000000000),
...
class RFQReplyResponse(Packet):
    name = 'RFQReplyResponse'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("nRResponseHeaderME", "", NRResponseHeaderMEComp),
    TransactTime("transactTime", 0xFFFFFFFFFFFFFFFF),
...
class RFQRequest(Packet):
    ...
    QuoteID("quoteID", 0xFFFFFFFFFFFFFFFF),
    MarketSegmentID("marketSegmentID", 0x80000000),
    ByteEnumField("rFQPublishIndicator", RFQPublishIndicator.Market_Data, RFQPublishIndicator),
    ByteEnumField("rFQRequesterDisclosureInstruction", RFQRequesterDisclosureInstruction.No, RFQRequesterDisclosureInstruction),
    ByteEnumField("side", Side.Buy, Side),
    Pad1("pad1", ""),
    ]
...
class RFQSpecialistIssuerBroadcast(Packet):
    name = 'RFQSpecialistIssuerBroadcast'
    fields_desc = [
    PacketField("messageHeaderOut", "", MessageHeaderOutComp),
    PacketField("rBCHeaderME", "", RBCHeaderMEComp),
    SecurityID("securityID", 0x8000000000000000),
...
class TESTradeBroadcast(Packet):
    ...
    SettlCurrFxRate("settlCurrFxRate", 0x8000000000000000),
    AccruedInterestAmt("accruedInterestAmt", 0x8000000000000000),
    ...
    LEShortEnumField("trdType", TrdType.OTC, TrdType),
    LEShortEnumField("lastMkt", LastMkt.XETR, LastMkt),
    ByteEnumField("side", Side.Buy, Side),
    ByteEnumField("tradingCapacity", TradingCapacity.Customer, TradingCapacity),
    ByteEnumField("tradeReportType", TradeReportType.Submit, TradeReportType),
    ByteEnumField("transferReason", TransferReason.Owner, TransferReason),
    ByteEnumField("tradePublishIndicator", TradePublishIndicator.Do_Not_Publish_Trade, TradePublishIndicator),
    ByteEnumField("deliveryType", DeliveryType.AKV, DeliveryType),
    ByteEnumField("lastCouponDeviationIndicator", LastCouponDeviationIndicator.NONE, LastCouponDeviationIndicator),
    ByteEnumField("refinancingEligibilityIndicator", RefinancingEligibilityIndicator.No, RefinancingEligibilityIndicator),
    ByteEnumField("clearingInstruction", ClearingInstruction.Bilateral_netting_only, ClearingInstruction),
    ByteEnumField("orderAttributeLiquidityProvision", OrderAttributeLiquidityProvision.Y, OrderAttributeLiquidityProvision),
    ByteEnumField("executingTraderQualifier", ExecutingTraderQualifier.Algo, ExecutingTraderQualifier),
...
class XetraEnLightCreateDealNotification(Packet):
    ...
    CharEnumField("messageEventSource", MessageEventSource.Broadcast_to_Initiator, MessageEventSource),
    ByteEnumField("side", Side.Buy, Side),
    ByteEnumField("allocMethod", AllocMethod.Automatic_Random, AllocMethod),
    ByteEnumField("autoExecType", AutoExecType.MidPointBBO, AutoExecType),
...
class XetraEnLightNegotiationRequesterNotification(Packet):
    ...
    ByteEnumField("side", Side.Buy, Side),
    ByteEnumField("quoteType", QuoteType.Indicative, QuoteType),
    ByteEnumField("respondentType", RespondentType.Specified_market_participants, RespondentType),
    ByteEnumField("tradingCapacity", TradingCapacity.Customer, TradingCapacity),
    ByteEnumField("valueCheckTypeValue", ValueCheckTypeValue.Do_not_check, ValueCheckTypeValue),
    ByteEnumField("valueCheckTypeQuantity", ValueCheckTypeQuantity.Do_not_check, ValueCheckTypeQuantity),
    ByteEnumField("autoExecType", AutoExecType.MidPointBBO, AutoExecType),
